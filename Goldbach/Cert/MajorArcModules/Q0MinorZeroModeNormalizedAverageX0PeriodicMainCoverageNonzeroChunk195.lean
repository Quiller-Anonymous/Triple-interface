...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk195, JSON indices [19500,19600). -/

def PeriodicMainNonzeroRecordPairsChunk195 : Finset (ℕ × ℕ) :=
  ([
    (659, 3295),
    (659, 3954),
    (659, 4613),
...
theorem PeriodicMainNonzeroRecordPairsChunk195_card :
    PeriodicMainNonzeroRecordPairsChunk195.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk195_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk195 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk195] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk195_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk195 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk195_subset_fullBlockExplicit hp
