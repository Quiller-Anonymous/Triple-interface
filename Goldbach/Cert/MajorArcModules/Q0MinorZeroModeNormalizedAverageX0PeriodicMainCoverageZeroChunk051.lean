...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk051, JSON indices [5100,5200). -/

def PeriodicMainZeroRecordPairsChunk051 : Finset (ℕ × ℕ) :=
  ([
    (3, 53),
    (3, 55),
    (3, 57),
...
theorem PeriodicMainZeroRecordPairsChunk051_card :
    PeriodicMainZeroRecordPairsChunk051.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk051_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk051] at hp
...
theorem PeriodicMainZeroRecordPairsChunk051_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk051_subset_fullBlockExplicit hp
