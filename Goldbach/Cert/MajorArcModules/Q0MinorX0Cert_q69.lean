...
private theorem centeredRamanujanObservableRat_X0_q69_eq_indicator
    (N : ℕ) :
    centeredRamanujanObservableRat X0 69 N
      = (5024 / 5001 : ℚ)
          - 3 * ramanujanGcdClassIndicatorRat 69 3 N
          - 23 * ramanujanGcdClassIndicatorRat 69 23 N
          + 43 * ramanujanGcdClassIndicatorRat 69 69 N := by
  have hdivs : (69 : ℕ).divisors = ({1, 3, 23, 69} : Finset ℕ) := by native_decide
  have hcoeff1 : ramanujanGcdClassCoeffRat 69 1 = 1 := by native_decide
  have hcoeff3 : ramanujanGcdClassCoeffRat 69 3 = -2 := by native_decide
  have hcoeff23 : ramanujanGcdClassCoeffRat 69 23 = -22 := by native_decide
  have hcoeff69 : ramanujanGcdClassCoeffRat 69 69 = 44 := by native_decide
  unfold centeredRamanujanObservableRat centeredRamanujanGcdClassObservableRat
  rw [hdivs]
  simp [hcoeff1, hcoeff3, hcoeff23, hcoeff69,
    ramanujanGcdClassWindowAverageRat_q69_1_X0,
    ramanujanGcdClassWindowAverageRat_q69_3_X0,
    ramanujanGcdClassWindowAverageRat_q69_23_X0,
    ramanujanGcdClassWindowAverageRat_q69_69_X0]
  linarith [ramanujanGcdClassIndicatorRat_q69_sum_eq_one N]

private theorem centeredRamanujanObservableRat_X0_q69_sq
    (N : ℕ) :
    (centeredRamanujanObservableRat X0 69 N) ^ 2
      = (25240576 / 25010001 : ℚ)
      + (4955 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 69 3 N
      + (2414425 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 69 23 N
      + (9678913 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 69 69 N := by
  rw [centeredRamanujanObservableRat_X0_q69_eq_indicator]
  unfold ramanujanGcdClassIndicatorRat
  by_cases h69 : Nat.gcd 69 N = 69
  · simp [h69]
    norm_num
...
private theorem centeredRamanujanWindowEnergyRat_X0_q69_eq_cert :
    centeredRamanujanWindowEnergyRat X0 69 = (1095923612 / 5001 : ℚ) := by
  calc
    centeredRamanujanWindowEnergyRat X0 69
        =
      ∑ N ∈ EvenIn X0 H,
        ((25240576 / 25010001 : ℚ)
          + (4955 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 69 3 N
          ...
          + (9678913 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 69 69 N) := by
            ...
            refine Finset.sum_congr rfl ?_
            intro N hN
            exact centeredRamanujanObservableRat_X0_q69_sq N
    _ =
      ∑ N ∈ EvenIn X0 H, (25240576 / 25010001 : ℚ)
        + (4955 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 69 3 N
        + (2414425 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 69 23 N
        + (9678913 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 69 69 N := by
          rw [Finset.sum_add_distrib, Finset.sum_add_distrib, Finset.sum_add_distrib,
            Finset.mul_sum, Finset.mul_sum, Finset.mul_sum]
    _ = (1095923612 / 5001 : ℚ) := by
          have hconst :
              ∑ N ∈ EvenIn X0 H, (25240576 / 25010001 : ℚ)
                =
              (5001 : ℚ) * (25240576 / 25010001 : ℚ) := by
            rw [Finset.sum_const, nsmul_eq_mul, evenIn_X0_H_card_eq_5001_explicit]
          rw [hconst,
            sum_ramanujanGcdClassIndicatorRat_q69_3_X0,
            sum_ramanujanGcdClassIndicatorRat_q69_23_X0,
            sum_ramanujanGcdClassIndicatorRat_q69_69_X0]
          norm_num

private theorem surrogateDiagonalTailTerm69_X0_eq_cert :
    surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 69
      = (6849522575 / 4686057024 : ℚ) := by
  have hsqfree : Squarefree 69 := by native_decide
  have hphi : Nat.totient 69 = 44 := by native_decide
  unfold surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat
  rw [centeredRamanujanWindowEnergyRat_X0_q69_eq_cert]
  simp [surrogateNormalizedSigmaTruncSummandCoeffRat, hsqfree, hphi]
  norm_num

theorem surrogateDiagonalTailChunk000Sub000Part021_eq_cert_explicit :
    (∑ q ∈ tailChunk000Sub000Part021SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part021 := by
  simp [tailChunk000Sub000Part021SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part021,
    surrogateDiagonalTailTerm69_X0_eq_cert]
