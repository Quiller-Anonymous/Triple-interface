...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk089, JSON indices [8900,9000). -/

def PeriodicMainNonzeroRecordPairsChunk089 : Finset (ℕ × ℕ) :=
  ([
    (62, 2139),
    (62, 2170),
    (62, 2201),
...
theorem PeriodicMainNonzeroRecordPairsChunk089_card :
    PeriodicMainNonzeroRecordPairsChunk089.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk089_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk089 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk089] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk089_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk089 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk089_subset_fullBlockExplicit hp
