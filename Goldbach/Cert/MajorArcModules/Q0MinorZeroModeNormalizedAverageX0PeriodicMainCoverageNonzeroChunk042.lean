...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk042, JSON indices [4200,4300). -/

def PeriodicMainNonzeroRecordPairsChunk042 : Finset (ℕ × ℕ) :=
  ([
    (17, 29),
    (17, 30),
    (17, 31),
...
theorem PeriodicMainNonzeroRecordPairsChunk042_card :
    PeriodicMainNonzeroRecordPairsChunk042.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk042_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk042 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk042] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk042_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk042 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk042_subset_fullBlockExplicit hp
