...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk104, JSON indices [10400,10500). -/

def PeriodicMainNonzeroRecordPairsChunk104 : Finset (ℕ × ℕ) :=
  ([
    (86, 31),
    (86, 33),
    (86, 34),
...
theorem PeriodicMainNonzeroRecordPairsChunk104_card :
    PeriodicMainNonzeroRecordPairsChunk104.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk104_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk104 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk104] at hp
  ...
  · subst p
    have hqCoeff : 86 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 31 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 86 ∈ PeriodicMainActiveSupportExplicit := by
...
theorem PeriodicMainNonzeroRecordPairsChunk104_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk104 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk104_subset_fullBlockExplicit hp
