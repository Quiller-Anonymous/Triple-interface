...
def tailChunk000Sub000Part023SupportExplicit : Finset ℕ :=
  ([85] : List ℕ).toFinset

def surrogateDiagTailX0RatChunk000Sub000Part023 : ℚ :=
  (10022659325 / 20975714304 : ℚ)

private theorem sum_ramanujanGcdClassIndicatorRat_q85_5_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 5 N) = 942 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q85_17_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 17 N) = 235 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q85_85_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 85 N) = 59 := by
  native_decide

private theorem ramanujanGcdClassWindowAverageRat_q85_1_X0 :
    ramanujanGcdClassWindowAverageRat X0 85 1 = (1255 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 85 N = 1)).card : ℚ) = 3765 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q85_5_X0 :
    ramanujanGcdClassWindowAverageRat X0 85 5 = (314 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 85 N = 5)).card : ℚ) = 942 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q85_17_X0 :
    ramanujanGcdClassWindowAverageRat X0 85 17 = (235 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 85 N = 17)).card : ℚ) = 235 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q85_85_X0 :
    ramanujanGcdClassWindowAverageRat X0 85 85 = (59 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 85 N = 85)).card : ℚ) = 59 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassIndicatorRat_q85_sum_eq_one
    (N : ℕ) :
    ramanujanGcdClassIndicatorRat 85 1 N
      + ramanujanGcdClassIndicatorRat 85 5 N
      + ramanujanGcdClassIndicatorRat 85 17 N
      + ramanujanGcdClassIndicatorRat 85 85 N = 1 := by
  unfold ramanujanGcdClassIndicatorRat
  by_cases h85 : Nat.gcd 85 N = 85
  · simp [h85]
  · by_cases h17 : Nat.gcd 85 N = 17
    · simp [h85, h17]
    · by_cases h5 : Nat.gcd 85 N = 5
      · simp [h85, h17, h5]
      · have hdivs : (85 : ℕ).divisors = ({1, 5, 17, 85} : Finset ℕ) := by native_decide
        have hmem : Nat.gcd 85 N ∈ ({1, 5, 17, 85} : Finset ℕ) := by
          rw [← hdivs]
          exact Nat.mem_divisors.mpr ⟨Nat.gcd_dvd_left 85 N, by norm_num⟩
        have h1 : Nat.gcd 85 N = 1 := by
          simpa [h85, h17, h5] using hmem
        simp [h85, h17, h5, h1]

private theorem centeredRamanujanObservableRat_X0_q85_eq_indicator
    (N : ℕ) :
    centeredRamanujanObservableRat X0 85 N
      = (4988 / 5001 : ℚ)
          - 5 * ramanujanGcdClassIndicatorRat 85 5 N
          - 17 * ramanujanGcdClassIndicatorRat 85 17 N
          + 63 * ramanujanGcdClassIndicatorRat 85 85 N := by
  have hdivs : (85 : ℕ).divisors = ({1, 5, 17, 85} : Finset ℕ) := by native_decide
  have hcoeff1 : ramanujanGcdClassCoeffRat 85 1 = 1 := by native_decide
  have hcoeff5 : ramanujanGcdClassCoeffRat 85 5 = -4 := by native_decide
  have hcoeff17 : ramanujanGcdClassCoeffRat 85 17 = -16 := by native_decide
  have hcoeff85 : ramanujanGcdClassCoeffRat 85 85 = 64 := by native_decide
  unfold centeredRamanujanObservableRat centeredRamanujanGcdClassObservableRat
  rw [hdivs]
  simp [hcoeff1, hcoeff5, hcoeff17, hcoeff85,
    ramanujanGcdClassWindowAverageRat_q85_1_X0,
    ramanujanGcdClassWindowAverageRat_q85_5_X0,
    ramanujanGcdClassWindowAverageRat_q85_17_X0,
    ramanujanGcdClassWindowAverageRat_q85_85_X0]
  linarith [ramanujanGcdClassIndicatorRat_q85_sum_eq_one N]

private theorem centeredRamanujanObservableRat_X0_q85_sq
    (N : ℕ) :
    (centeredRamanujanObservableRat X0 85 N) ^ 2
      = (24880144 / 25010001 : ℚ)
      + (75145 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 85 5 N
      + (1275697 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 85 17 N
      + (6825819 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 85 85 N := by
  rw [centeredRamanujanObservableRat_X0_q85_eq_indicator]
  unfold ramanujanGcdClassIndicatorRat
  by_cases h85 : Nat.gcd 85 N = 85
  · simp [h85]
    norm_num
...
private theorem centeredRamanujanWindowEnergyRat_X0_q85_eq_cert :
    centeredRamanujanWindowEnergyRat X0 85 = (1603625492 / 5001 : ℚ) := by
  calc
    centeredRamanujanWindowEnergyRat X0 85
        =
      ∑ N ∈ EvenIn X0 H,
        ((24880144 / 25010001 : ℚ)
          + (75145 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 85 5 N
          ...
          + (6825819 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 85 85 N) := by
            ...
            refine Finset.sum_congr rfl ?_
            intro N hN
            exact centeredRamanujanObservableRat_X0_q85_sq N
    _ =
      ∑ N ∈ EvenIn X0 H, (24880144 / 25010001 : ℚ)
        + (75145 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 5 N
        + (1275697 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 17 N
        + (6825819 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 85 85 N := by
          rw [Finset.sum_add_distrib, Finset.sum_add_distrib, Finset.sum_add_distrib,
            Finset.mul_sum, Finset.mul_sum, Finset.mul_sum]
    _ = (1603625492 / 5001 : ℚ) := by
          have hconst :
              ∑ N ∈ EvenIn X0 H, (24880144 / 25010001 : ℚ)
                =
            ...
            rw [Finset.sum_const, nsmul_eq_mul, evenIn_X0_H_card_eq_5001_explicit]
          rw [hconst,
            sum_ramanujanGcdClassIndicatorRat_q85_5_X0,
            sum_ramanujanGcdClassIndicatorRat_q85_17_X0,
            sum_ramanujanGcdClassIndicatorRat_q85_85_X0]
          norm_num

private theorem surrogateDiagonalTailTerm85_X0_eq_cert :
    surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 85
      = (10022659325 / 20975714304 : ℚ) := by
  have hsqfree : Squarefree 85 := by native_decide
  have hphi : Nat.totient 85 = 64 := by native_decide
  unfold surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat
  rw [centeredRamanujanWindowEnergyRat_X0_q85_eq_cert]
  simp [surrogateNormalizedSigmaTruncSummandCoeffRat, hsqfree, hphi]
  norm_num

theorem surrogateDiagonalTailChunk000Sub000Part023_eq_cert_explicit :
    (∑ q ∈ tailChunk000Sub000Part023SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part023 := by
  simp [tailChunk000Sub000Part023SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part023,
    surrogateDiagonalTailTerm85_X0_eq_cert]
