...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk102, JSON indices [10200,10300). -/

def PeriodicMainZeroRecordPairsChunk102 : Finset (ℕ × ℕ) :=
  ([
    (255, 42),
    (255, 51),
    (255, 102),
...
theorem PeriodicMainZeroRecordPairsChunk102_card :
    PeriodicMainZeroRecordPairsChunk102.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk102_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk102 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk102] at hp
...
theorem PeriodicMainZeroRecordPairsChunk102_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk102 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk102_subset_fullBlockExplicit hp
