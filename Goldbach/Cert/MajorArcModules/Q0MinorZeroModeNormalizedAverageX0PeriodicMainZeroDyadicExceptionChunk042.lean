...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk042, JSON indices [4200,4300). -/

def PeriodicMainZeroDyadicExceptionPairsChunk042 : Finset (ℕ × ℕ) :=
  ([
    (111, 2442),
    (111, 2553),
    (111, 2886),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk042_card :
    PeriodicMainZeroDyadicExceptionPairsChunk042.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk042_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk042 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk042] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk042_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk042 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk042_subset_fullBlockExplicit hp
