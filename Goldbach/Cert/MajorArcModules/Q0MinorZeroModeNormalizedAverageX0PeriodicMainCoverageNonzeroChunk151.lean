...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk151, JSON indices [15100,15200). -/

def PeriodicMainNonzeroRecordPairsChunk151 : Finset (ℕ × ℕ) :=
  ([
    (247, 57),
    (247, 65),
    (247, 78),
...
theorem PeriodicMainNonzeroRecordPairsChunk151_card :
    PeriodicMainNonzeroRecordPairsChunk151.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk151_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk151 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk151] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk151_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk151 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk151_subset_fullBlockExplicit hp
