...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk223, JSON indices [22300,22400). -/

def PeriodicMainNonzeroRecordPairsChunk223 : Finset (ℕ × ℕ) :=
  ([
    (1205, 482),
    (1205, 2410),
    (1205, 3615),
...
theorem PeriodicMainNonzeroRecordPairsChunk223_card :
    PeriodicMainNonzeroRecordPairsChunk223.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk223_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk223 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk223] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk223_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk223 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk223_subset_fullBlockExplicit hp
