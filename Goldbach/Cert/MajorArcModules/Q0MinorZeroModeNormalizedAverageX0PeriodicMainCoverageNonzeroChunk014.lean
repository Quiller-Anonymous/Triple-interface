...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk014, JSON indices [1400,1500). -/

def PeriodicMainNonzeroRecordPairsChunk014 : Finset (ℕ × ℕ) :=
  ([
    (7, 966),
    (7, 973),
    (7, 987),
...
theorem PeriodicMainNonzeroRecordPairsChunk014_card :
    PeriodicMainNonzeroRecordPairsChunk014.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk014_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk014 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk014] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk014_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk014 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk014_subset_fullBlockExplicit hp
