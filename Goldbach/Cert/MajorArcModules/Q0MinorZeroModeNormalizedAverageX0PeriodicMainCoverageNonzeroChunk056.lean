...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk056, JSON indices [5600,5700). -/

def PeriodicMainNonzeroRecordPairsChunk056 : Finset (ℕ × ℕ) :=
  ([
    (26, 2405),
    (26, 2418),
    (26, 2431),
...
theorem PeriodicMainNonzeroRecordPairsChunk056_card :
    PeriodicMainNonzeroRecordPairsChunk056.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk056_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk056 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk056] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk056_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk056 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk056_subset_fullBlockExplicit hp
