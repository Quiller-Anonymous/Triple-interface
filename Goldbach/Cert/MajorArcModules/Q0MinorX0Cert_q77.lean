...
def tailChunk000Sub000Part022SupportExplicit : Finset ℕ :=
  ([77] : List ℕ).toFinset

def surrogateDiagTailX0RatChunk000Sub000Part022 : ℚ :=
  (41711257 / 72014400 : ℚ)

private theorem sum_ramanujanGcdClassIndicatorRat_q77_7_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 7 N) = 649 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q77_11_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 11 N) = 390 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q77_77_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 77 N) = 65 := by
  native_decide

private theorem ramanujanGcdClassWindowAverageRat_q77_1_X0 :
    ramanujanGcdClassWindowAverageRat X0 77 1 = (1299 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 77 N = 1)).card : ℚ) = 3897 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q77_7_X0 :
    ramanujanGcdClassWindowAverageRat X0 77 7 = (649 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 77 N = 7)).card : ℚ) = 649 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q77_11_X0 :
    ramanujanGcdClassWindowAverageRat X0 77 11 = (130 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 77 N = 11)).card : ℚ) = 390 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q77_77_X0 :
    ramanujanGcdClassWindowAverageRat X0 77 77 = (65 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 77 N = 77)).card : ℚ) = 65 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassIndicatorRat_q77_sum_eq_one
    (N : ℕ) :
    ramanujanGcdClassIndicatorRat 77 1 N
      + ramanujanGcdClassIndicatorRat 77 7 N
      + ramanujanGcdClassIndicatorRat 77 11 N
      + ramanujanGcdClassIndicatorRat 77 77 N = 1 := by
  unfold ramanujanGcdClassIndicatorRat
  by_cases h77 : Nat.gcd 77 N = 77
  · simp [h77]
  · by_cases h11 : Nat.gcd 77 N = 11
    · simp [h77, h11]
    · by_cases h7 : Nat.gcd 77 N = 7
      · simp [h77, h11, h7]
      · have hdivs : (77 : ℕ).divisors = ({1, 7, 11, 77} : Finset ℕ) := by native_decide
        have hmem : Nat.gcd 77 N ∈ ({1, 7, 11, 77} : Finset ℕ) := by
          rw [← hdivs]
          exact Nat.mem_divisors.mpr ⟨Nat.gcd_dvd_left 77 N, by norm_num⟩
        have h1 : Nat.gcd 77 N = 1 := by
          simpa [h77, h11, h7] using hmem
        simp [h77, h11, h7, h1]

private theorem centeredRamanujanObservableRat_X0_q77_eq_indicator
    (N : ℕ) :
    centeredRamanujanObservableRat X0 77 N
      = (1666 / 1667 : ℚ)
          - 7 * ramanujanGcdClassIndicatorRat 77 7 N
          - 11 * ramanujanGcdClassIndicatorRat 77 11 N
          + 59 * ramanujanGcdClassIndicatorRat 77 77 N := by
  have hdivs : (77 : ℕ).divisors = ({1, 7, 11, 77} : Finset ℕ) := by native_decide
  have hcoeff1 : ramanujanGcdClassCoeffRat 77 1 = 1 := by native_decide
  have hcoeff7 : ramanujanGcdClassCoeffRat 77 7 = -6 := by native_decide
  have hcoeff11 : ramanujanGcdClassCoeffRat 77 11 = -10 := by native_decide
  have hcoeff77 : ramanujanGcdClassCoeffRat 77 77 = 60 := by native_decide
  unfold centeredRamanujanObservableRat centeredRamanujanGcdClassObservableRat
  rw [hdivs]
  simp [hcoeff1, hcoeff7, hcoeff11, hcoeff77,
    ramanujanGcdClassWindowAverageRat_q77_1_X0,
    ramanujanGcdClassWindowAverageRat_q77_7_X0,
    ramanujanGcdClassWindowAverageRat_q77_11_X0,
    ramanujanGcdClassWindowAverageRat_q77_77_X0]
  linarith [ramanujanGcdClassIndicatorRat_q77_sum_eq_one N]

private theorem centeredRamanujanObservableRat_X0_q77_sq
    (N : ℕ) :
    (centeredRamanujanObservableRat X0 77 N) ^ 2
      = (2775556 / 2778889 : ℚ)
      + (58359 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 77 7 N
      + (165055 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 77 11 N
      + (5999415 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 77 77 N := by
  rw [centeredRamanujanObservableRat_X0_q77_eq_indicator]
  unfold ramanujanGcdClassIndicatorRat
  by_cases h77 : Nat.gcd 77 N = 77
  · simp [h77]
    norm_num
...
private theorem centeredRamanujanWindowEnergyRat_X0_q77_eq_cert :
    centeredRamanujanWindowEnergyRat X0 77 = (500535084 / 1667 : ℚ) := by
  calc
    centeredRamanujanWindowEnergyRat X0 77
        =
      ∑ N ∈ EvenIn X0 H,
        ((2775556 / 2778889 : ℚ)
          + (58359 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 77 7 N
          ...
          + (5999415 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 77 77 N) := by
            ...
            refine Finset.sum_congr rfl ?_
            intro N hN
            exact centeredRamanujanObservableRat_X0_q77_sq N
    _ =
      ∑ N ∈ EvenIn X0 H, (2775556 / 2778889 : ℚ)
        + (58359 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 7 N
        + (165055 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 11 N
        + (5999415 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 77 77 N := by
          rw [Finset.sum_add_distrib, Finset.sum_add_distrib, Finset.sum_add_distrib,
            Finset.mul_sum, Finset.mul_sum, Finset.mul_sum]
    _ = (500535084 / 1667 : ℚ) := by
          have hconst :
              ∑ N ∈ EvenIn X0 H, (2775556 / 2778889 : ℚ)
                =
            ...
            rw [Finset.sum_const, nsmul_eq_mul, evenIn_X0_H_card_eq_5001_explicit]
          rw [hconst,
            sum_ramanujanGcdClassIndicatorRat_q77_7_X0,
            sum_ramanujanGcdClassIndicatorRat_q77_11_X0,
            sum_ramanujanGcdClassIndicatorRat_q77_77_X0]
          norm_num

private theorem surrogateDiagonalTailTerm77_X0_eq_cert :
    surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 77
      = (41711257 / 72014400 : ℚ) := by
  have hsqfree : Squarefree 77 := by native_decide
  have hphi : Nat.totient 77 = 60 := by native_decide
  unfold surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat
  rw [centeredRamanujanWindowEnergyRat_X0_q77_eq_cert]
  simp [surrogateNormalizedSigmaTruncSummandCoeffRat, hsqfree, hphi]
  norm_num

theorem surrogateDiagonalTailChunk000Sub000Part022_eq_cert_explicit :
    (∑ q ∈ tailChunk000Sub000Part022SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part022 := by
  simp [tailChunk000Sub000Part022SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part022,
    surrogateDiagonalTailTerm77_X0_eq_cert]
