...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk119, JSON indices [11900,12000). -/

def PeriodicMainNonzeroRecordPairsChunk119 : Finset (ℕ × ℕ) :=
  ([
    (122, 29),
    (122, 30),
    (122, 31),
...
theorem PeriodicMainNonzeroRecordPairsChunk119_card :
    PeriodicMainNonzeroRecordPairsChunk119.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk119_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk119 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk119] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk119_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk119 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk119_subset_fullBlockExplicit hp
