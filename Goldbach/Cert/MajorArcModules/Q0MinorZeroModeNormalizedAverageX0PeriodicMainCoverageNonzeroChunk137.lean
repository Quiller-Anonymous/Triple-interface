...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk137, JSON indices [13700,13800). -/

def PeriodicMainNonzeroRecordPairsChunk137 : Finset (ℕ × ℕ) :=
  ([
    (185, 85),
    (185, 95),
    (185, 105),
...
theorem PeriodicMainNonzeroRecordPairsChunk137_card :
    PeriodicMainNonzeroRecordPairsChunk137.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk137_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk137 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk137] at hp
  ...
  · subst p
    have hqCoeff : 185 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 85 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 185 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 186 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 186 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk137_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk137 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk137_subset_fullBlockExplicit hp
