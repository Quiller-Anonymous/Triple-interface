...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk070, JSON indices [7000,7100). -/

def PeriodicMainNonzeroRecordPairsChunk070 : Finset (ℕ × ℕ) :=
  ([
    (35, 4830),
    (35, 4865),
    (35, 4935),
...
theorem PeriodicMainNonzeroRecordPairsChunk070_card :
    PeriodicMainNonzeroRecordPairsChunk070.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk070_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk070 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk070] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk070_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk070 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk070_subset_fullBlockExplicit hp
