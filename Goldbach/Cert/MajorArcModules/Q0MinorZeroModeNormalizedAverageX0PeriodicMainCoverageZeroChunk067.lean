...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk067, JSON indices [6700,6800). -/

def PeriodicMainZeroRecordPairsChunk067 : Finset (ℕ × ℕ) :=
  ([
    (6, 111),
    (6, 113),
    (6, 114),
...
theorem PeriodicMainZeroRecordPairsChunk067_card :
    PeriodicMainZeroRecordPairsChunk067.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk067_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk067 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk067] at hp
...
theorem PeriodicMainZeroRecordPairsChunk067_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk067 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk067_subset_fullBlockExplicit hp
