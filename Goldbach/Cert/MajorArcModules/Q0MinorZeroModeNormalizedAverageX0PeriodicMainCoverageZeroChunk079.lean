...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk079, JSON indices [7900,8000). -/

def PeriodicMainZeroRecordPairsChunk079 : Finset (ℕ × ℕ) :=
  ([
    (21, 51),
    (21, 53),
    (21, 55),
...
theorem PeriodicMainZeroRecordPairsChunk079_card :
    PeriodicMainZeroRecordPairsChunk079.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk079_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk079 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk079] at hp
...
theorem PeriodicMainZeroRecordPairsChunk079_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk079 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk079_subset_fullBlockExplicit hp
