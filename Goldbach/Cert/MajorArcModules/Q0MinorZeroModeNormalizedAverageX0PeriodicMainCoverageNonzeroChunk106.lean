...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk106, JSON indices [10600,10700). -/

def PeriodicMainNonzeroRecordPairsChunk106 : Finset (ℕ × ℕ) :=
  ([
    (89, 3382),
    (89, 3471),
    (89, 3649),
...
theorem PeriodicMainNonzeroRecordPairsChunk106_card :
    PeriodicMainNonzeroRecordPairsChunk106.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk106_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk106 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk106] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 91 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 91 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk106_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk106 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk106_subset_fullBlockExplicit hp
