...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk141, JSON indices [14100,14200). -/

def PeriodicMainNonzeroRecordPairsChunk141 : Finset (ℕ × ℕ) :=
  ([
    (202, 13),
    (202, 14),
    (202, 15),
...
theorem PeriodicMainNonzeroRecordPairsChunk141_card :
    PeriodicMainNonzeroRecordPairsChunk141.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk141_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk141 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk141] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk141_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk141 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk141_subset_fullBlockExplicit hp
