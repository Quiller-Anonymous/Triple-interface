...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk081, JSON indices [8100,8200). -/

def PeriodicMainZeroRecordPairsChunk081 : Finset (ℕ × ℕ) :=
  ([
    (21, 633),
    (21, 642),
    (21, 645),
...
theorem PeriodicMainZeroRecordPairsChunk081_card :
    PeriodicMainZeroRecordPairsChunk081.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk081_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk081 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk081] at hp
...
theorem PeriodicMainZeroRecordPairsChunk081_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk081 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk081_subset_fullBlockExplicit hp
