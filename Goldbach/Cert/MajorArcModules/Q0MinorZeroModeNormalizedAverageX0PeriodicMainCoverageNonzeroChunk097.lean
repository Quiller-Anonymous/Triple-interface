...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk097, JSON indices [9700,9800). -/

def PeriodicMainNonzeroRecordPairsChunk097 : Finset (ℕ × ℕ) :=
  ([
    (73, 730),
    (73, 803),
    (73, 949),
...
theorem PeriodicMainNonzeroRecordPairsChunk097_card :
    PeriodicMainNonzeroRecordPairsChunk097.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk097_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk097 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk097] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk097_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk097 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk097_subset_fullBlockExplicit hp
