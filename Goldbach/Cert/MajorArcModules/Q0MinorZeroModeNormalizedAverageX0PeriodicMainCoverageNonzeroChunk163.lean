...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk163, JSON indices [16300,16400). -/

def PeriodicMainNonzeroRecordPairsChunk163 : Finset (ℕ × ℕ) :=
  ([
    (322, 23),
    (322, 26),
    (322, 30),
...
theorem PeriodicMainNonzeroRecordPairsChunk163_card :
    PeriodicMainNonzeroRecordPairsChunk163.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk163_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk163 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk163] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk163_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk163 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk163_subset_fullBlockExplicit hp
