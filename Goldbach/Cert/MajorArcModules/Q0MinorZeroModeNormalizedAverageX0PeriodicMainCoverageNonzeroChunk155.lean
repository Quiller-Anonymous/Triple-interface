...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk155, JSON indices [15500,15600). -/

def PeriodicMainNonzeroRecordPairsChunk155 : Finset (ℕ × ℕ) :=
  ([
    (273, 26),
    (273, 30),
    (273, 33),
...
theorem PeriodicMainNonzeroRecordPairsChunk155_card :
    PeriodicMainNonzeroRecordPairsChunk155.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk155_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk155 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk155] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk155_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk155 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk155_subset_fullBlockExplicit hp
