...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk122, JSON indices [12200,12300). -/

def PeriodicMainNonzeroRecordPairsChunk122 : Finset (ℕ × ℕ) :=
  ([
    (133, 19),
    (133, 22),
    (133, 23),
...
theorem PeriodicMainNonzeroRecordPairsChunk122_card :
    PeriodicMainNonzeroRecordPairsChunk122.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk122_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk122 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk122] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk122_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk122 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk122_subset_fullBlockExplicit hp
