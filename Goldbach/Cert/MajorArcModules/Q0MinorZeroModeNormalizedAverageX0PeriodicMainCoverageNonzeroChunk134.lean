...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk134, JSON indices [13400,13500). -/

def PeriodicMainNonzeroRecordPairsChunk134 : Finset (ℕ × ℕ) :=
  ([
    (174, 23),
    (174, 26),
    (174, 29),
...
theorem PeriodicMainNonzeroRecordPairsChunk134_card :
    PeriodicMainNonzeroRecordPairsChunk134.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk134_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk134 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk134] at hp
  ...
  · subst p
    have hqCoeff : 174 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 23 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 174 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 177 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 177 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk134_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk134 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk134_subset_fullBlockExplicit hp
