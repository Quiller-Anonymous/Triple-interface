...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk017, JSON indices [1700,1800). -/

def PeriodicMainNonzeroRecordPairsChunk017 : Finset (ℕ × ℕ) :=
  ([
    (10, 5),
    (10, 7),
    (10, 11),
...
theorem PeriodicMainNonzeroRecordPairsChunk017_card :
    PeriodicMainNonzeroRecordPairsChunk017.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk017_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk017 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk017] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk017_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk017 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk017_subset_fullBlockExplicit hp
