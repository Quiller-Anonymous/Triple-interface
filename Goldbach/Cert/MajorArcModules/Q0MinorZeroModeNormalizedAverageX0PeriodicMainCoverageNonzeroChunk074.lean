...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk074, JSON indices [7400,7500). -/

def PeriodicMainNonzeroRecordPairsChunk074 : Finset (ℕ × ℕ) :=
  ([
    (39, 109),
    (39, 110),
    (39, 113),
...
theorem PeriodicMainNonzeroRecordPairsChunk074_card :
    PeriodicMainNonzeroRecordPairsChunk074.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk074_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk074 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk074] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk074_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk074 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk074_subset_fullBlockExplicit hp
