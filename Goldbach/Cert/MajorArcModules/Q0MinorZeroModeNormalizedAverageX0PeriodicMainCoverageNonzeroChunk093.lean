...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk093, JSON indices [9300,9400). -/

def PeriodicMainNonzeroRecordPairsChunk093 : Finset (ℕ × ℕ) :=
  ([
    (69, 14),
    (69, 15),
    (69, 17),
...
theorem PeriodicMainNonzeroRecordPairsChunk093_card :
    PeriodicMainNonzeroRecordPairsChunk093.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk093_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk093 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk093] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk093_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk093 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk093_subset_fullBlockExplicit hp
