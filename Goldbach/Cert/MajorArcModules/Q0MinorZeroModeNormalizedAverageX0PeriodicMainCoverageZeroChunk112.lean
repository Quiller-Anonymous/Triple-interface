...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk112, JSON indices [11200,11300). -/

def PeriodicMainZeroRecordPairsChunk112 : Finset (ℕ × ℕ) :=
  ([
    (493, 2),
    (493, 3),
    (493, 6),
...
theorem PeriodicMainZeroRecordPairsChunk112_card :
    PeriodicMainZeroRecordPairsChunk112.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk112_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk112 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk112] at hp
...
theorem PeriodicMainZeroRecordPairsChunk112_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk112 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk112_subset_fullBlockExplicit hp
