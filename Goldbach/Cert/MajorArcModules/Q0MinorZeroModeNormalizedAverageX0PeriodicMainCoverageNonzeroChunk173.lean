...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk173, JSON indices [17300,17400). -/

def PeriodicMainNonzeroRecordPairsChunk173 : Finset (ℕ × ℕ) :=
  ([
    (403, 65),
    (403, 78),
    (403, 91),
...
theorem PeriodicMainNonzeroRecordPairsChunk173_card :
    PeriodicMainNonzeroRecordPairsChunk173.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk173_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk173 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk173] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk173_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk173 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk173_subset_fullBlockExplicit hp
