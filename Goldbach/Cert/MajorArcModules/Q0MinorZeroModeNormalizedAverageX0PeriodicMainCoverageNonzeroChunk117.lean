...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk117, JSON indices [11700,11800). -/

def PeriodicMainNonzeroRecordPairsChunk117 : Finset (ℕ × ℕ) :=
  ([
    (115, 155),
    (115, 161),
    (115, 165),
...
theorem PeriodicMainNonzeroRecordPairsChunk117_card :
    PeriodicMainNonzeroRecordPairsChunk117.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk117_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk117 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk117] at hp
  ...
  · subst p
    have hqCoeff : 115 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 155 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 115 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 118 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 118 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk117_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk117 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk117_subset_fullBlockExplicit hp
