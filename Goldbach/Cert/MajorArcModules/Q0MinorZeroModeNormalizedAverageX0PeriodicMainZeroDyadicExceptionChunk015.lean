...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk015, JSON indices [1500,1600). -/

def PeriodicMainZeroDyadicExceptionPairsChunk015 : Finset (ℕ × ℕ) :=
  ([
    (3, 4845),
    (3, 4854),
    (3, 4857),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk015_card :
    PeriodicMainZeroDyadicExceptionPairsChunk015.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk015_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk015 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk015] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk015_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk015 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk015_subset_fullBlockExplicit hp
