...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk066, JSON indices [6600,6700). -/

def PeriodicMainNonzeroRecordPairsChunk066 : Finset (ℕ × ℕ) :=
  ([
    (34, 106),
    (34, 107),
    (34, 109),
...
theorem PeriodicMainNonzeroRecordPairsChunk066_card :
    PeriodicMainNonzeroRecordPairsChunk066.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk066_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk066 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk066] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk066_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk066 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk066_subset_fullBlockExplicit hp
