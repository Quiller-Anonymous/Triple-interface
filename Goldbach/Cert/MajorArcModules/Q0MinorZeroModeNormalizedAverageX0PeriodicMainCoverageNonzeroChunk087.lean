...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk087, JSON indices [8700,8800). -/

def PeriodicMainNonzeroRecordPairsChunk087 : Finset (ℕ × ℕ) :=
  ([
    (59, 3599),
    (59, 3658),
    (59, 3835),
...
theorem PeriodicMainNonzeroRecordPairsChunk087_card :
    PeriodicMainNonzeroRecordPairsChunk087.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk087_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk087 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk087] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 61 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 61 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk087_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk087 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk087_subset_fullBlockExplicit hp
