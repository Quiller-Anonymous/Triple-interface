...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk013, JSON indices [1300,1400). -/

def PeriodicMainNonzeroRecordPairsChunk013 : Finset (ℕ × ℕ) :=
  ([
    (7, 577),
    (7, 579),
    (7, 581),
...
theorem PeriodicMainNonzeroRecordPairsChunk013_card :
    PeriodicMainNonzeroRecordPairsChunk013.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk013_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk013 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk013] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk013_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk013 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk013_subset_fullBlockExplicit hp
