...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk205, JSON indices [20500,20600). -/

def PeriodicMainNonzeroRecordPairsChunk205 : Finset (ℕ × ℕ) :=
  ([
    (803, 55),
    (803, 66),
    (803, 73),
...
theorem PeriodicMainNonzeroRecordPairsChunk205_card :
    PeriodicMainNonzeroRecordPairsChunk205.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk205_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk205 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk205] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk205_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk205 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk205_subset_fullBlockExplicit hp
