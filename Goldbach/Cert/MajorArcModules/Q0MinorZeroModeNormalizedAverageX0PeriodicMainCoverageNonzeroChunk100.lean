...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk100, JSON indices [10000,10100). -/

def PeriodicMainNonzeroRecordPairsChunk100 : Finset (ℕ × ℕ) :=
  ([
    (78, 174),
    (78, 177),
    (78, 182),
...
theorem PeriodicMainNonzeroRecordPairsChunk100_card :
    PeriodicMainNonzeroRecordPairsChunk100.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk100_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk100 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk100] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk100_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk100 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk100_subset_fullBlockExplicit hp
