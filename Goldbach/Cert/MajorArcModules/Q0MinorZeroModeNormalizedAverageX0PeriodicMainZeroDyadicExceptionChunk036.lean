...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk036, JSON indices [3600,3700). -/

def PeriodicMainZeroDyadicExceptionPairsChunk036 : Finset (ℕ × ℕ) :=
  ([
    (46, 6),
    (46, 21),
    (46, 42),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk036_card :
    PeriodicMainZeroDyadicExceptionPairsChunk036.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk036_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk036 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk036] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk036_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk036 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk036_subset_fullBlockExplicit hp
