...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk169, JSON indices [16900,17000). -/

def PeriodicMainNonzeroRecordPairsChunk169 : Finset (ℕ × ℕ) :=
  ([
    (370, 814),
    (370, 962),
    (370, 1110),
...
theorem PeriodicMainNonzeroRecordPairsChunk169_card :
    PeriodicMainNonzeroRecordPairsChunk169.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk169_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk169 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk169] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk169_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk169 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk169_subset_fullBlockExplicit hp
