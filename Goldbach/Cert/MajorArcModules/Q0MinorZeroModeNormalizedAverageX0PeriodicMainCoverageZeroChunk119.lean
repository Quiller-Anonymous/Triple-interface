...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk119, JSON indices [11900,12000). -/

def PeriodicMainZeroRecordPairsChunk119 : Finset (ℕ × ℕ) :=
  ([
    (687, 6),
    (687, 21),
    (689, 1),
...
theorem PeriodicMainZeroRecordPairsChunk119_card :
    PeriodicMainZeroRecordPairsChunk119.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk119_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk119 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk119] at hp
...
theorem PeriodicMainZeroRecordPairsChunk119_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk119 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk119_subset_fullBlockExplicit hp
