...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk045, JSON indices [4500,4600). -/

def PeriodicMainNonzeroRecordPairsChunk045 : Finset (ℕ × ℕ) :=
  ([
    (17, 4845),
    (17, 4862),
    (17, 4879),
...
theorem PeriodicMainNonzeroRecordPairsChunk045_card :
    PeriodicMainNonzeroRecordPairsChunk045.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk045_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk045 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk045] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk045_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk045 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk045_subset_fullBlockExplicit hp
