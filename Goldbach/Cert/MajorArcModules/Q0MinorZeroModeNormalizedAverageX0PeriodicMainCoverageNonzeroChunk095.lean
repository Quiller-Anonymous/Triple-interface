...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk095, JSON indices [9500,9600). -/

def PeriodicMainNonzeroRecordPairsChunk095 : Finset (ℕ × ℕ) :=
  ([
    (70, 335),
    (70, 345),
    (70, 355),
...
theorem PeriodicMainNonzeroRecordPairsChunk095_card :
    PeriodicMainNonzeroRecordPairsChunk095.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk095_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk095 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk095] at hp
  ...
  · subst p
    have hqCoeff : 70 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 335 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 70 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 71 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 71 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk095_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk095 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk095_subset_fullBlockExplicit hp
