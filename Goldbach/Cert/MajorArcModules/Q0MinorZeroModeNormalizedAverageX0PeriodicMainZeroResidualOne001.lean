...
/- Generated periodic-main ordered-record proofs for JSON indices [1,2). -/
...
def PeriodicMainRecordsZeroResidualOne001Pairs : Finset (ℕ × ℕ) :=
  [(7, 2919)].toFinset

theorem PeriodicMainRecordsZeroResidualOne001_value_on_records :
    ∀ p ∈ PeriodicMainRecordsZeroResidualOne001Pairs,
      surrogatePeriodicMainActiveOrderedPairSummandRat X0 p = 0 := by
  intro p hp
  simp [PeriodicMainRecordsZeroResidualOne001Pairs] at hp
  rcases hp with h
  · subst p
