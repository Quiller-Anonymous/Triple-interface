...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk128, JSON indices [12800,12900). -/

def PeriodicMainNonzeroRecordPairsChunk128 : Finset (ℕ × ℕ) :=
  ([
    (151, 33),
    (151, 302),
    (151, 755),
...
theorem PeriodicMainNonzeroRecordPairsChunk128_card :
    PeriodicMainNonzeroRecordPairsChunk128.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk128_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk128 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk128] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk128_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk128 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk128_subset_fullBlockExplicit hp
