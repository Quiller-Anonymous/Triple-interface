...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk175, JSON indices [17500,17600). -/

def PeriodicMainNonzeroRecordPairsChunk175 : Finset (ℕ × ℕ) :=
  ([
    (421, 4210),
    (421, 4631),
    (422, 5),
...
theorem PeriodicMainNonzeroRecordPairsChunk175_card :
    PeriodicMainNonzeroRecordPairsChunk175.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk175_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk175 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk175] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk175_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk175 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk175_subset_fullBlockExplicit hp
