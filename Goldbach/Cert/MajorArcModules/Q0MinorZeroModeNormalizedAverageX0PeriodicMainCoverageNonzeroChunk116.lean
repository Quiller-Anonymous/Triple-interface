...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk116, JSON indices [11600,11700). -/

def PeriodicMainNonzeroRecordPairsChunk116 : Finset (ℕ × ℕ) :=
  ([
    (114, 62),
    (114, 66),
    (114, 69),
...
theorem PeriodicMainNonzeroRecordPairsChunk116_card :
    PeriodicMainNonzeroRecordPairsChunk116.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk116_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk116 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk116] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk116_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk116 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk116_subset_fullBlockExplicit hp
