...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk098, JSON indices [9800,9900). -/

def PeriodicMainNonzeroRecordPairsChunk098 : Finset (ℕ × ℕ) :=
  ([
    (74, 1258),
    (74, 1295),
    (74, 1406),
...
theorem PeriodicMainNonzeroRecordPairsChunk098_card :
    PeriodicMainNonzeroRecordPairsChunk098.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk098_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk098 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk098] at hp
  ...
  · subst p
    have hqCoeff : 74 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 1258 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 74 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 77 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 77 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk098_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk098 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk098_subset_fullBlockExplicit hp
