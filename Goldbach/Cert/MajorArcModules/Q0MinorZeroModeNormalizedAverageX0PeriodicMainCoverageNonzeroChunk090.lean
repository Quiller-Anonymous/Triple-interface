...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk090, JSON indices [9000,9100). -/

def PeriodicMainNonzeroRecordPairsChunk090 : Finset (ℕ × ℕ) :=
  ([
    (65, 355),
    (65, 365),
    (65, 370),
...
theorem PeriodicMainNonzeroRecordPairsChunk090_card :
    PeriodicMainNonzeroRecordPairsChunk090.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk090_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk090 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk090] at hp
  ...
  · subst p
    have hqCoeff : 65 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 355 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 65 ∈ PeriodicMainActiveSupportExplicit := by
...
theorem PeriodicMainNonzeroRecordPairsChunk090_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk090 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk090_subset_fullBlockExplicit hp
