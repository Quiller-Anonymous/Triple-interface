...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk105, JSON indices [10500,10600). -/

def PeriodicMainNonzeroRecordPairsChunk105 : Finset (ℕ × ℕ) :=
  ([
    (87, 105),
    (87, 114),
    (87, 123),
...
theorem PeriodicMainNonzeroRecordPairsChunk105_card :
    PeriodicMainNonzeroRecordPairsChunk105.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk105_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk105 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk105] at hp
  ...
  · subst p
    have hqCoeff : 87 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 105 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 87 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 89 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 89 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk105_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk105 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk105_subset_fullBlockExplicit hp
