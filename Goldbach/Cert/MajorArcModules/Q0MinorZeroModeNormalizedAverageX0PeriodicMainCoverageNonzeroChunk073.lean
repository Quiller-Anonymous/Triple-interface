...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk073, JSON indices [7300,7400). -/

def PeriodicMainNonzeroRecordPairsChunk073 : Finset (ℕ × ℕ) :=
  ([
    (38, 1995),
    (38, 2014),
    (38, 2033),
...
theorem PeriodicMainNonzeroRecordPairsChunk073_card :
    PeriodicMainNonzeroRecordPairsChunk073.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk073_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk073 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk073] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 39 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 39 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk073_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk073 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk073_subset_fullBlockExplicit hp
