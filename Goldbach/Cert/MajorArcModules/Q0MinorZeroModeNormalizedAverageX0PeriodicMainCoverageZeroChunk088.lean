...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk088, JSON indices [8800,8900). -/

def PeriodicMainZeroRecordPairsChunk088 : Finset (ℕ × ℕ) :=
  ([
    (51, 114),
    (51, 119),
    (51, 123),
...
theorem PeriodicMainZeroRecordPairsChunk088_card :
    PeriodicMainZeroRecordPairsChunk088.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk088_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk088 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk088] at hp
...
theorem PeriodicMainZeroRecordPairsChunk088_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk088 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk088_subset_fullBlockExplicit hp
