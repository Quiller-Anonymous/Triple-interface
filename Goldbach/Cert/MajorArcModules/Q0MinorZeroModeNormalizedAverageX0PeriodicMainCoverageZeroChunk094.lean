...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk094, JSON indices [9400,9500). -/

def PeriodicMainZeroRecordPairsChunk094 : Finset (ℕ × ℕ) :=
  ([
    (111, 2109),
    (111, 2442),
    (111, 2553),
...
theorem PeriodicMainZeroRecordPairsChunk094_card :
    PeriodicMainZeroRecordPairsChunk094.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk094_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk094 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk094] at hp
...
theorem PeriodicMainZeroRecordPairsChunk094_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk094 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk094_subset_fullBlockExplicit hp
