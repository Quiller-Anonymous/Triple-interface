...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk041, JSON indices [4100,4200). -/

def PeriodicMainZeroDyadicExceptionPairsChunk041 : Finset (ℕ × ℕ) :=
  ([
    (103, 3),
    (103, 6),
    (103, 21),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk041_card :
    PeriodicMainZeroDyadicExceptionPairsChunk041.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk041_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk041 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk041] at hp
  ...
  · subst p
    have hqCoeff : 103 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 3 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 103 ∈ PeriodicMainActiveSupportExplicit := by
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk041_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk041 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk041_subset_fullBlockExplicit hp
