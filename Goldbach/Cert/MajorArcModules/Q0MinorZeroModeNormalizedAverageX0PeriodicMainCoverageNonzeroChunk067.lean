...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk067, JSON indices [6700,6800). -/

def PeriodicMainNonzeroRecordPairsChunk067 : Finset (ℕ × ℕ) :=
  ([
    (34, 1785),
    (34, 1802),
    (34, 1819),
...
theorem PeriodicMainNonzeroRecordPairsChunk067_card :
    PeriodicMainNonzeroRecordPairsChunk067.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk067_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk067 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk067] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk067_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk067 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk067_subset_fullBlockExplicit hp
