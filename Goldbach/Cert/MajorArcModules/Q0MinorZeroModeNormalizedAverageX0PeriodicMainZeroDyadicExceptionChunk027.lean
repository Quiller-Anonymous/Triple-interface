...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk027, JSON indices [2700,2800). -/

def PeriodicMainZeroDyadicExceptionPairsChunk027 : Finset (ℕ × ℕ) :=
  ([
    (14, 474),
    (14, 498),
    (14, 534),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk027_card :
    PeriodicMainZeroDyadicExceptionPairsChunk027.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk027_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk027 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk027] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk027_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk027 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk027_subset_fullBlockExplicit hp
