...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk131, JSON indices [13100,13200). -/

def PeriodicMainNonzeroRecordPairsChunk131 : Finset (ℕ × ℕ) :=
  ([
    (161, 182),
    (161, 203),
    (161, 210),
...
theorem PeriodicMainNonzeroRecordPairsChunk131_card :
    PeriodicMainNonzeroRecordPairsChunk131.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk131_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk131 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk131] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 163 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 163 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk131_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk131 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk131_subset_fullBlockExplicit hp
