...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk268, JSON indices [26800,26900). -/

def PeriodicMainNonzeroRecordPairsChunk268 : Finset (ℕ × ℕ) :=
  ([
    (2810, 1405),
    (2811, 937),
    (2813, 29),
...
theorem PeriodicMainNonzeroRecordPairsChunk268_card :
    PeriodicMainNonzeroRecordPairsChunk268.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk268_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk268 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk268] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk268_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk268 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk268_subset_fullBlockExplicit hp
