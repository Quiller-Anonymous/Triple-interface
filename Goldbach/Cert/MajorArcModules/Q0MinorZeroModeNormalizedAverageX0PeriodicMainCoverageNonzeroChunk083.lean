...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk083, JSON indices [8300,8400). -/

def PeriodicMainNonzeroRecordPairsChunk083 : Finset (ℕ × ℕ) :=
  ([
    (55, 627),
    (55, 638),
    (55, 649),
...
theorem PeriodicMainNonzeroRecordPairsChunk083_card :
    PeriodicMainNonzeroRecordPairsChunk083.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk083_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk083 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk083] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk083_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk083 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk083_subset_fullBlockExplicit hp
