...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk010, JSON indices [1000,1100). -/

def PeriodicMainNonzeroRecordPairsChunk010 : Finset (ℕ × ℕ) :=
  ([
    (7, 53),
    (7, 55),
    (7, 57),
...
theorem PeriodicMainNonzeroRecordPairsChunk010_card :
    PeriodicMainNonzeroRecordPairsChunk010.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk010_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk010 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk010] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk010_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk010 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk010_subset_fullBlockExplicit hp
