...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk091, JSON indices [9100,9200). -/

def PeriodicMainNonzeroRecordPairsChunk091 : Finset (ℕ × ℕ) :=
  ([
    (66, 78),
    (66, 82),
    (66, 86),
...
theorem PeriodicMainNonzeroRecordPairsChunk091_card :
    PeriodicMainNonzeroRecordPairsChunk091.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk091_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk091 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk091] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk091_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk091 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk091_subset_fullBlockExplicit hp
