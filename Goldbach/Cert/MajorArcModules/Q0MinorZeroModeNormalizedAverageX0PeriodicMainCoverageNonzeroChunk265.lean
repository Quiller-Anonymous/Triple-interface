...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk265, JSON indices [26500,26600). -/

def PeriodicMainNonzeroRecordPairsChunk265 : Finset (ℕ × ℕ) :=
  ([
    (2630, 1315),
    (2631, 877),
    (2634, 1317),
...
theorem PeriodicMainNonzeroRecordPairsChunk265_card :
    PeriodicMainNonzeroRecordPairsChunk265.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk265_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk265 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk265] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk265_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk265 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk265_subset_fullBlockExplicit hp
