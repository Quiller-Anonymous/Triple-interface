...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk136, JSON indices [13600,13700). -/

def PeriodicMainNonzeroRecordPairsChunk136 : Finset (ℕ × ℕ) :=
  ([
    (182, 77),
    (182, 78),
    (182, 91),
...
theorem PeriodicMainNonzeroRecordPairsChunk136_card :
    PeriodicMainNonzeroRecordPairsChunk136.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk136_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk136 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk136] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk136_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk136 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk136_subset_fullBlockExplicit hp
