...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk106, JSON indices [10600,10700). -/

def PeriodicMainZeroRecordPairsChunk106 : Finset (ℕ × ℕ) :=
  ([
    (339, 4746),
    (341, 1),
    (341, 2),
...
theorem PeriodicMainZeroRecordPairsChunk106_card :
    PeriodicMainZeroRecordPairsChunk106.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk106_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk106 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk106] at hp
...
theorem PeriodicMainZeroRecordPairsChunk106_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk106 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk106_subset_fullBlockExplicit hp
