...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk120, JSON indices [12000,12100). -/

def PeriodicMainNonzeroRecordPairsChunk120 : Finset (ℕ × ℕ) :=
  ([
    (123, 1517),
    (123, 1558),
    (123, 1599),
...
theorem PeriodicMainNonzeroRecordPairsChunk120_card :
    PeriodicMainNonzeroRecordPairsChunk120.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk120_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk120 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk120] at hp
  ...
  · subst p
    have hqCoeff : 123 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 1517 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 123 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 127 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 127 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk120_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk120 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk120_subset_fullBlockExplicit hp
