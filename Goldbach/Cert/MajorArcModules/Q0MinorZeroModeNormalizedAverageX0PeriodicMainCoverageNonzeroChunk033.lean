...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk033, JSON indices [3300,3400). -/

def PeriodicMainNonzeroRecordPairsChunk033 : Finset (ℕ × ℕ) :=
  ([
    (14, 109),
    (14, 110),
    (14, 113),
...
theorem PeriodicMainNonzeroRecordPairsChunk033_card :
    PeriodicMainNonzeroRecordPairsChunk033.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk033_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk033 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk033] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk033_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk033 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk033_subset_fullBlockExplicit hp
