...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk000, JSON indices [0,100). -/

def PeriodicMainNonzeroRecordPairsChunk000 : Finset (ℕ × ℕ) :=
  ([
    (3, 6),
    (5, 7),
    (5, 10),
...
theorem PeriodicMainNonzeroRecordPairsChunk000_card :
    PeriodicMainNonzeroRecordPairsChunk000.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk000_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk000] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk000_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk000_subset_fullBlockExplicit hp
