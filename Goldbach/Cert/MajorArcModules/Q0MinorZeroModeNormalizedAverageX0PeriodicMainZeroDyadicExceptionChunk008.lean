...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk008, JSON indices [800,900). -/

def PeriodicMainZeroDyadicExceptionPairsChunk008 : Finset (ℕ × ℕ) :=
  ([
    (3, 1317),
    (3, 1318),
    (3, 1319),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk008_card :
    PeriodicMainZeroDyadicExceptionPairsChunk008.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk008_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk008 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk008] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk008_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk008 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk008_subset_fullBlockExplicit hp
