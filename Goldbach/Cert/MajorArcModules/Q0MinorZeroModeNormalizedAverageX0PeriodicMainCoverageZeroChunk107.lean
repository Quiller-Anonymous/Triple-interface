...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk107, JSON indices [10700,10800). -/

def PeriodicMainZeroRecordPairsChunk107 : Finset (ℕ × ℕ) :=
  ([
    (365, 6),
    (366, 1),
    (366, 2),
...
theorem PeriodicMainZeroRecordPairsChunk107_card :
    PeriodicMainZeroRecordPairsChunk107.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk107_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk107 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk107] at hp
...
theorem PeriodicMainZeroRecordPairsChunk107_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk107 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk107_subset_fullBlockExplicit hp
