...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk075, JSON indices [7500,7600). -/

def PeriodicMainNonzeroRecordPairsChunk075 : Finset (ℕ × ℕ) :=
  ([
    (39, 1651),
    (39, 1677),
    (39, 1794),
...
theorem PeriodicMainNonzeroRecordPairsChunk075_card :
    PeriodicMainNonzeroRecordPairsChunk075.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk075_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk075 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk075] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk075_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk075 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk075_subset_fullBlockExplicit hp
