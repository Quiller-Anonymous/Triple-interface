...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk099, JSON indices [9900,10000). -/

def PeriodicMainZeroRecordPairsChunk099 : Finset (ℕ × ℕ) :=
  ([
    (209, 1),
    (209, 2),
    (209, 3),
...
theorem PeriodicMainZeroRecordPairsChunk099_card :
    PeriodicMainZeroRecordPairsChunk099.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk099_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk099 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk099] at hp
...
theorem PeriodicMainZeroRecordPairsChunk099_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk099 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk099_subset_fullBlockExplicit hp
