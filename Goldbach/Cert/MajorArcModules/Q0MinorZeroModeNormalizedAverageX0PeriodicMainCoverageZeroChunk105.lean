...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk105, JSON indices [10500,10600). -/

def PeriodicMainZeroRecordPairsChunk105 : Finset (ℕ × ℕ) :=
  ([
    (318, 2),
    (318, 3),
    (318, 6),
...
theorem PeriodicMainZeroRecordPairsChunk105_card :
    PeriodicMainZeroRecordPairsChunk105.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk105_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk105 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk105] at hp
...
theorem PeriodicMainZeroRecordPairsChunk105_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk105 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk105_subset_fullBlockExplicit hp
