...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk031, JSON indices [3100,3200). -/

def PeriodicMainZeroRecordPairsChunk031 : Finset (ℕ × ℕ) :=
  ([
    (2, 97),
    (2, 101),
    (2, 102),
...
theorem PeriodicMainZeroRecordPairsChunk031_card :
    PeriodicMainZeroRecordPairsChunk031.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk031_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk031 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk031] at hp
...
theorem PeriodicMainZeroRecordPairsChunk031_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk031 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk031_subset_fullBlockExplicit hp
