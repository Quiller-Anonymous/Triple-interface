...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk100, JSON indices [10000,10100). -/

def PeriodicMainZeroRecordPairsChunk100 : Finset (ℕ × ℕ) :=
  ([
    (222, 185),
    (222, 259),
    (222, 370),
...
theorem PeriodicMainZeroRecordPairsChunk100_card :
    PeriodicMainZeroRecordPairsChunk100.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk100_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk100 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk100] at hp
...
theorem PeriodicMainZeroRecordPairsChunk100_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk100 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk100_subset_fullBlockExplicit hp
