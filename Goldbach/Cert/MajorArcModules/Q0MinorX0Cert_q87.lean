...
def tailChunk000Sub000Part024SupportExplicit : Finset ℕ :=
  ([87] : List ℕ).toFinset

def surrogateDiagTailX0RatChunk000Sub000Part024 : ℚ :=
  (17414159125 / 24591157248 : ℚ)

private theorem sum_ramanujanGcdClassIndicatorRat_q87_3_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 3 N) = 1610 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q87_29_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 29 N) = 115 := by
  native_decide

private theorem sum_ramanujanGcdClassIndicatorRat_q87_87_X0 :
    (∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 87 N) = 57 := by
  native_decide

private theorem ramanujanGcdClassWindowAverageRat_q87_1_X0 :
    ramanujanGcdClassWindowAverageRat X0 87 1 = (1073 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 87 N = 1)).card : ℚ) = 3219 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q87_3_X0 :
    ramanujanGcdClassWindowAverageRat X0 87 3 = (1610 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 87 N = 3)).card : ℚ) = 1610 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q87_29_X0 :
    ramanujanGcdClassWindowAverageRat X0 87 29 = (115 / 5001 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 87 N = 29)).card : ℚ) = 115 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassWindowAverageRat_q87_87_X0 :
    ramanujanGcdClassWindowAverageRat X0 87 87 = (19 / 1667 : ℚ) := by
  have hcount :
      (((EvenIn X0 H).filter (fun N => Nat.gcd 87 N = 87)).card : ℚ) = 57 := by
    native_decide
  unfold ramanujanGcdClassWindowAverageRat
  rw [evenIn_X0_H_card_eq_5001_explicit, hcount]
  norm_num

private theorem ramanujanGcdClassIndicatorRat_q87_sum_eq_one
    (N : ℕ) :
    ramanujanGcdClassIndicatorRat 87 1 N
      + ramanujanGcdClassIndicatorRat 87 3 N
      + ramanujanGcdClassIndicatorRat 87 29 N
      + ramanujanGcdClassIndicatorRat 87 87 N = 1 := by
  unfold ramanujanGcdClassIndicatorRat
  by_cases h87 : Nat.gcd 87 N = 87
  · simp [h87]
  · by_cases h29 : Nat.gcd 87 N = 29
    · simp [h87, h29]
    · by_cases h3 : Nat.gcd 87 N = 3
      · simp [h87, h29, h3]
      · have hdivs : (87 : ℕ).divisors = ({1, 3, 29, 87} : Finset ℕ) := by native_decide
        have hmem : Nat.gcd 87 N ∈ ({1, 3, 29, 87} : Finset ℕ) := by
          rw [← hdivs]
          exact Nat.mem_divisors.mpr ⟨Nat.gcd_dvd_left 87 N, by norm_num⟩
        have h1 : Nat.gcd 87 N = 1 := by
          simpa [h87, h29, h3] using hmem
        simp [h87, h29, h3, h1]

private theorem centeredRamanujanObservableRat_X0_q87_eq_indicator
    (N : ℕ) :
    centeredRamanujanObservableRat X0 87 N
      = (5030 / 5001 : ℚ)
          - 3 * ramanujanGcdClassIndicatorRat 87 3 N
          - 29 * ramanujanGcdClassIndicatorRat 87 29 N
          + 55 * ramanujanGcdClassIndicatorRat 87 87 N := by
  have hdivs : (87 : ℕ).divisors = ({1, 3, 29, 87} : Finset ℕ) := by native_decide
  have hcoeff1 : ramanujanGcdClassCoeffRat 87 1 = 1 := by native_decide
  have hcoeff3 : ramanujanGcdClassCoeffRat 87 3 = -2 := by native_decide
  have hcoeff29 : ramanujanGcdClassCoeffRat 87 29 = -28 := by native_decide
  have hcoeff87 : ramanujanGcdClassCoeffRat 87 87 = 56 := by native_decide
  unfold centeredRamanujanObservableRat centeredRamanujanGcdClassObservableRat
  rw [hdivs]
  simp [hcoeff1, hcoeff3, hcoeff29, hcoeff87,
    ramanujanGcdClassWindowAverageRat_q87_1_X0,
    ramanujanGcdClassWindowAverageRat_q87_3_X0,
    ramanujanGcdClassWindowAverageRat_q87_29_X0,
    ramanujanGcdClassWindowAverageRat_q87_87_X0]
  linarith [ramanujanGcdClassIndicatorRat_q87_sum_eq_one N]

private theorem centeredRamanujanObservableRat_X0_q87_sq
    (N : ℕ) :
    (centeredRamanujanObservableRat X0 87 N) ^ 2
      = (25300900 / 25010001 : ℚ)
      + (4943 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 87 3 N
      + (3914101 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 87 29 N
      + (15681325 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 87 87 N := by
  rw [centeredRamanujanObservableRat_X0_q87_eq_indicator]
  unfold ramanujanGcdClassIndicatorRat
  by_cases h87 : Nat.gcd 87 N = 87
  · simp [h87]
    norm_num
...
private theorem centeredRamanujanWindowEnergyRat_X0_q87_eq_cert :
    centeredRamanujanWindowEnergyRat X0 87 = (1393132730 / 5001 : ℚ) := by
  calc
    centeredRamanujanWindowEnergyRat X0 87
        =
      ∑ N ∈ EvenIn X0 H,
        ((25300900 / 25010001 : ℚ)
          + (4943 / 1667 : ℚ) * ramanujanGcdClassIndicatorRat 87 3 N
          ...
          + (15681325 / 5001 : ℚ) * ramanujanGcdClassIndicatorRat 87 87 N) := by
            ...
            refine Finset.sum_congr rfl ?_
            intro N hN
            exact centeredRamanujanObservableRat_X0_q87_sq N
    _ =
      ∑ N ∈ EvenIn X0 H, (25300900 / 25010001 : ℚ)
        + (4943 / 1667 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 3 N
        + (3914101 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 29 N
        + (15681325 / 5001 : ℚ) * ∑ N ∈ EvenIn X0 H, ramanujanGcdClassIndicatorRat 87 87 N := by
          rw [Finset.sum_add_distrib, Finset.sum_add_distrib, Finset.sum_add_distrib,
            Finset.mul_sum, Finset.mul_sum, Finset.mul_sum]
    _ = (1393132730 / 5001 : ℚ) := by
          have hconst :
              ∑ N ∈ EvenIn X0 H, (25300900 / 25010001 : ℚ)
                =
              (5001 : ℚ) * (25300900 / 25010001 : ℚ) := by
            rw [Finset.sum_const, nsmul_eq_mul, evenIn_X0_H_card_eq_5001_explicit]
          rw [hconst,
            sum_ramanujanGcdClassIndicatorRat_q87_3_X0,
            sum_ramanujanGcdClassIndicatorRat_q87_29_X0,
            sum_ramanujanGcdClassIndicatorRat_q87_87_X0]
          norm_num

private theorem surrogateDiagonalTailTerm87_X0_eq_cert :
    surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 87
      = (17414159125 / 24591157248 : ℚ) := by
  have hsqfree : Squarefree 87 := by native_decide
  have hphi : Nat.totient 87 = 56 := by native_decide
  unfold surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat
  rw [centeredRamanujanWindowEnergyRat_X0_q87_eq_cert]
  simp [surrogateNormalizedSigmaTruncSummandCoeffRat, hsqfree, hphi]
  norm_num

theorem surrogateDiagonalTailChunk000Sub000Part024_eq_cert_explicit :
    (∑ q ∈ tailChunk000Sub000Part024SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part024 := by
  simp [tailChunk000Sub000Part024SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part024,
    surrogateDiagonalTailTerm87_X0_eq_cert]
