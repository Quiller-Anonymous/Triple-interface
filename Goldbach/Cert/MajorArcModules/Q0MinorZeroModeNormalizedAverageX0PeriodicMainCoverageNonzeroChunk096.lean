...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk096, JSON indices [9600,9700). -/

def PeriodicMainNonzeroRecordPairsChunk096 : Finset (ℕ × ℕ) :=
  ([
    (71, 39),
    (71, 41),
    (71, 43),
...
theorem PeriodicMainNonzeroRecordPairsChunk096_card :
    PeriodicMainNonzeroRecordPairsChunk096.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk096_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk096 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk096] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 73 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 73 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk096_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk096 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk096_subset_fullBlockExplicit hp
