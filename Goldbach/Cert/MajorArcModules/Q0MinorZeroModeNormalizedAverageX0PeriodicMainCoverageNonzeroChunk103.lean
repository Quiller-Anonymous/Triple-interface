...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk103, JSON indices [10300,10400). -/

def PeriodicMainNonzeroRecordPairsChunk103 : Finset (ℕ × ℕ) :=
  ([
    (85, 26),
    (85, 29),
    (85, 30),
...
theorem PeriodicMainNonzeroRecordPairsChunk103_card :
    PeriodicMainNonzeroRecordPairsChunk103.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk103_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk103 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk103] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk103_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk103 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk103_subset_fullBlockExplicit hp
