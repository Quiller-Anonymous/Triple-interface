...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk179, JSON indices [17900,18000). -/

def PeriodicMainNonzeroRecordPairsChunk179 : Finset (ℕ × ℕ) :=
  ([
    (455, 14),
    (455, 15),
    (455, 26),
...
theorem PeriodicMainNonzeroRecordPairsChunk179_card :
    PeriodicMainNonzeroRecordPairsChunk179.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk179_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk179 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk179] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk179_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk179 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk179_subset_fullBlockExplicit hp
