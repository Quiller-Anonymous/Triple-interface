...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk086, JSON indices [8600,8700). -/

def PeriodicMainZeroDyadicExceptionPairsChunk086 : Finset (ℕ × ℕ) :=
  ([
    (2798, 2),
    (2802, 3),
    (2802, 6),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk086_card :
    PeriodicMainZeroDyadicExceptionPairsChunk086.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk086_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk086 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk086] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk086_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk086 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk086_subset_fullBlockExplicit hp
