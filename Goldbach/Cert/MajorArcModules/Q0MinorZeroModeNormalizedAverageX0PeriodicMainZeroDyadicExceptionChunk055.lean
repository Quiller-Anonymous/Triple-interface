...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk055, JSON indices [5500,5600). -/

def PeriodicMainZeroDyadicExceptionPairsChunk055 : Finset (ℕ × ℕ) :=
  ([
    (467, 6),
    (469, 3),
    (469, 6),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk055_card :
    PeriodicMainZeroDyadicExceptionPairsChunk055.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk055_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk055 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk055] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk055_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk055 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk055_subset_fullBlockExplicit hp
