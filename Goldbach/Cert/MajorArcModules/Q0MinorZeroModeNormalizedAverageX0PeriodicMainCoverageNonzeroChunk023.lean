...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk023, JSON indices [2300,2400). -/

def PeriodicMainNonzeroRecordPairsChunk023 : Finset (ℕ × ℕ) :=
  ([
    (10, 3710),
    (10, 3730),
    (10, 3770),
...
theorem PeriodicMainNonzeroRecordPairsChunk023_card :
    PeriodicMainNonzeroRecordPairsChunk023.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk023_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk023 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk023] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk023_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk023 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk023_subset_fullBlockExplicit hp
