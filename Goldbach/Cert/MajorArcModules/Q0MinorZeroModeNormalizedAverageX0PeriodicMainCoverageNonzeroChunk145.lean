...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk145, JSON indices [14500,14600). -/

def PeriodicMainNonzeroRecordPairsChunk145 : Finset (ℕ × ℕ) :=
  ([
    (215, 23),
    (215, 30),
    (215, 35),
...
theorem PeriodicMainNonzeroRecordPairsChunk145_card :
    PeriodicMainNonzeroRecordPairsChunk145.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk145_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk145 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk145] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk145_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk145 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk145_subset_fullBlockExplicit hp
