...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk126, JSON indices [12600,12700). -/

def PeriodicMainNonzeroRecordPairsChunk126 : Finset (ℕ × ℕ) :=
  ([
    (143, 110),
    (143, 130),
    (143, 154),
...
theorem PeriodicMainNonzeroRecordPairsChunk126_card :
    PeriodicMainNonzeroRecordPairsChunk126.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk126_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk126 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk126] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk126_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk126 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk126_subset_fullBlockExplicit hp
