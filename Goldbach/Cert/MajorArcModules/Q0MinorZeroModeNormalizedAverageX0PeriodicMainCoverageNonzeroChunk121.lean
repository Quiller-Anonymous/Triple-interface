...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk121, JSON indices [12100,12200). -/

def PeriodicMainNonzeroRecordPairsChunk121 : Finset (ℕ × ℕ) :=
  ([
    (130, 182),
    (130, 185),
    (130, 190),
...
theorem PeriodicMainNonzeroRecordPairsChunk121_card :
    PeriodicMainNonzeroRecordPairsChunk121.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk121_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk121 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk121] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk121_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk121 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk121_subset_fullBlockExplicit hp
