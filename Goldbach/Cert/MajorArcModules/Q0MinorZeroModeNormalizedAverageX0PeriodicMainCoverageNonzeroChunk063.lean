...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk063, JSON indices [6300,6400). -/

def PeriodicMainNonzeroRecordPairsChunk063 : Finset (ℕ × ℕ) :=
  ([
    (31, 4371),
    (31, 4402),
    (31, 4433),
...
theorem PeriodicMainNonzeroRecordPairsChunk063_card :
    PeriodicMainNonzeroRecordPairsChunk063.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk063_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk063 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk063] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk063_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk063 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk063_subset_fullBlockExplicit hp
