...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk288, JSON indices [28800,28900). -/

def PeriodicMainNonzeroRecordPairsChunk288 : Finset (ℕ × ℕ) :=
  ([
    (3974, 1987),
    (3977, 41),
    (3977, 97),
...
theorem PeriodicMainNonzeroRecordPairsChunk288_card :
    PeriodicMainNonzeroRecordPairsChunk288.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk288_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk288 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk288] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk288_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk288 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk288_subset_fullBlockExplicit hp
