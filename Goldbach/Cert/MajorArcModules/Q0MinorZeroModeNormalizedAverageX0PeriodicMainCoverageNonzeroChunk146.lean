...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk146, JSON indices [14600,14700). -/

def PeriodicMainNonzeroRecordPairsChunk146 : Finset (ℕ × ℕ) :=
  ([
    (218, 1417),
    (218, 1526),
    (218, 1635),
...
theorem PeriodicMainNonzeroRecordPairsChunk146_card :
    PeriodicMainNonzeroRecordPairsChunk146.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk146_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk146 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk146] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk146_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk146 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk146_subset_fullBlockExplicit hp
