...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk138, JSON indices [13800,13900). -/

def PeriodicMainNonzeroRecordPairsChunk138 : Finset (ℕ × ℕ) :=
  ([
    (187, 77),
    (187, 85),
    (187, 110),
...
theorem PeriodicMainNonzeroRecordPairsChunk138_card :
    PeriodicMainNonzeroRecordPairsChunk138.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk138_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk138 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk138] at hp
  ...
  · subst p
    have hqCoeff : 187 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 77 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 187 ∈ PeriodicMainActiveSupportExplicit := by
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 190 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 190 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk138_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk138 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk138_subset_fullBlockExplicit hp
