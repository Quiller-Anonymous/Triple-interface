...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk085, JSON indices [8500,8600). -/

def PeriodicMainNonzeroRecordPairsChunk085 : Finset (ℕ × ℕ) :=
  ([
    (58, 15),
    (58, 17),
    (58, 19),
...
theorem PeriodicMainNonzeroRecordPairsChunk085_card :
    PeriodicMainNonzeroRecordPairsChunk085.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk085_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk085 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk085] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk085_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk085 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk085_subset_fullBlockExplicit hp
