...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk084, JSON indices [8400,8500). -/

def PeriodicMainZeroRecordPairsChunk084 : Finset (ℕ × ℕ) :=
  ([
    (37, 42),
    (37, 51),
    (37, 102),
...
theorem PeriodicMainZeroRecordPairsChunk084_card :
    PeriodicMainZeroRecordPairsChunk084.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk084_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk084 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk084] at hp
...
theorem PeriodicMainZeroRecordPairsChunk084_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk084 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk084_subset_fullBlockExplicit hp
