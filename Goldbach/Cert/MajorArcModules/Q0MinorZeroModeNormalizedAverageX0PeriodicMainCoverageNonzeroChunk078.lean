...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk078, JSON indices [7800,7900). -/

def PeriodicMainNonzeroRecordPairsChunk078 : Finset (ℕ × ℕ) :=
  ([
    (43, 4859),
    (43, 4902),
    (43, 4945),
...
theorem PeriodicMainNonzeroRecordPairsChunk078_card :
    PeriodicMainNonzeroRecordPairsChunk078.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk078_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk078 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk078] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk078_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk078 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk078_subset_fullBlockExplicit hp
