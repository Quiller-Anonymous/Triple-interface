...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk157, JSON indices [15700,15800). -/

def PeriodicMainNonzeroRecordPairsChunk157 : Finset (ℕ × ℕ) :=
  ([
    (285, 210),
    (285, 247),
    (285, 255),
...
theorem PeriodicMainNonzeroRecordPairsChunk157_card :
    PeriodicMainNonzeroRecordPairsChunk157.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk157_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk157 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk157] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk157_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk157 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk157_subset_fullBlockExplicit hp
