...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk061, JSON indices [6100,6200). -/

def PeriodicMainNonzeroRecordPairsChunk061 : Finset (ℕ × ℕ) :=
  ([
    (30, 2055),
    (30, 2085),
    (30, 2130),
...
theorem PeriodicMainNonzeroRecordPairsChunk061_card :
    PeriodicMainNonzeroRecordPairsChunk061.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk061_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk061 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk061] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk061_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk061 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk061_subset_fullBlockExplicit hp
