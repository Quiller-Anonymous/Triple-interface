...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk148, JSON indices [14800,14900). -/

def PeriodicMainNonzeroRecordPairsChunk148 : Finset (ℕ × ℕ) :=
  ([
    (230, 22),
    (230, 23),
    (230, 26),
...
theorem PeriodicMainNonzeroRecordPairsChunk148_card :
    PeriodicMainNonzeroRecordPairsChunk148.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk148_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk148 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk148] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk148_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk148 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk148_subset_fullBlockExplicit hp
