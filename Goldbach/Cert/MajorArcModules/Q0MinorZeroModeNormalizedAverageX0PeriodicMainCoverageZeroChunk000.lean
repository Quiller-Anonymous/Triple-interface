...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk000, JSON indices [0,100). -/

def PeriodicMainZeroRecordPairsChunk000 : Finset (ℕ × ℕ) :=
  ([
    (1, 2),
    (1, 3),
    (1, 5),
...
theorem PeriodicMainZeroRecordPairsChunk000_card :
    PeriodicMainZeroRecordPairsChunk000.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk000_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk000] at hp
...
theorem PeriodicMainZeroRecordPairsChunk000_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk000_subset_fullBlockExplicit hp
