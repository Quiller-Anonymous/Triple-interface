...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk269, JSON indices [26900,27000). -/

def PeriodicMainNonzeroRecordPairsChunk269 : Finset (ℕ × ℕ) :=
  ([
    (2874, 479),
    (2874, 958),
    (2874, 1437),
...
theorem PeriodicMainNonzeroRecordPairsChunk269_card :
    PeriodicMainNonzeroRecordPairsChunk269.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk269_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk269 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk269] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk269_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk269 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk269_subset_fullBlockExplicit hp
