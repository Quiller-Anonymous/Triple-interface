...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk092, JSON indices [9200,9300). -/

def PeriodicMainZeroRecordPairsChunk092 : Finset (ℕ × ℕ) :=
  ([
    (102, 34),
    (102, 35),
    (102, 37),
...
theorem PeriodicMainZeroRecordPairsChunk092_card :
    PeriodicMainZeroRecordPairsChunk092.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk092_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk092 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk092] at hp
...
theorem PeriodicMainZeroRecordPairsChunk092_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk092 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk092_subset_fullBlockExplicit hp
