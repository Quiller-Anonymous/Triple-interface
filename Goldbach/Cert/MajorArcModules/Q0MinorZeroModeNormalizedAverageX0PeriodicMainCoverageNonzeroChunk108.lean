...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk108, JSON indices [10800,10900). -/

def PeriodicMainNonzeroRecordPairsChunk108 : Finset (ℕ × ℕ) :=
  ([
    (94, 38),
    (94, 39),
    (94, 41),
...
theorem PeriodicMainNonzeroRecordPairsChunk108_card :
    PeriodicMainNonzeroRecordPairsChunk108.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk108_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk108 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk108] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk108_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk108 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk108_subset_fullBlockExplicit hp
