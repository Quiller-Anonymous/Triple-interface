...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk111, JSON indices [11100,11200). -/

def PeriodicMainNonzeroRecordPairsChunk111 : Finset (ℕ × ℕ) :=
  ([
    (103, 3090),
    (103, 3193),
    (103, 3399),
...
theorem PeriodicMainNonzeroRecordPairsChunk111_card :
    PeriodicMainNonzeroRecordPairsChunk111.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk111_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk111 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk111] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk111_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk111 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk111_subset_fullBlockExplicit hp
