...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk065, JSON indices [6500,6600). -/

def PeriodicMainNonzeroRecordPairsChunk065 : Finset (ℕ × ℕ) :=
  ([
    (33, 1661),
    (33, 1749),
    (33, 1914),
...
theorem PeriodicMainNonzeroRecordPairsChunk065_card :
    PeriodicMainNonzeroRecordPairsChunk065.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk065_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk065 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk065] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 34 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 34 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk065_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk065 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk065_subset_fullBlockExplicit hp
