...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk022, JSON indices [2200,2300). -/

def PeriodicMainZeroDyadicExceptionPairsChunk022 : Finset (ℕ × ℕ) :=
  ([
    (6, 1270),
    (6, 1281),
    (6, 1282),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk022_card :
    PeriodicMainZeroDyadicExceptionPairsChunk022.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk022_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk022 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk022] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk022_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk022 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk022_subset_fullBlockExplicit hp
