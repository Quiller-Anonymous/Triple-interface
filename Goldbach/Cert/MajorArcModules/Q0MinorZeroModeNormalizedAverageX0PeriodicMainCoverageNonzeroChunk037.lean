...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk037, JSON indices [3700,3800). -/

def PeriodicMainNonzeroRecordPairsChunk037 : Finset (ℕ × ℕ) :=
  ([
    (14, 4186),
    (14, 4242),
    (14, 4270),
...
theorem PeriodicMainNonzeroRecordPairsChunk037_card :
    PeriodicMainNonzeroRecordPairsChunk037.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk037_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk037 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk037] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk037_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk037 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk037_subset_fullBlockExplicit hp
