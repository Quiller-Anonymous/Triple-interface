...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk082, JSON indices [8200,8300). -/

def PeriodicMainNonzeroRecordPairsChunk082 : Finset (ℕ × ℕ) :=
  ([
    (55, 15),
    (55, 17),
    (55, 19),
...
theorem PeriodicMainNonzeroRecordPairsChunk082_card :
    PeriodicMainNonzeroRecordPairsChunk082.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk082_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk082 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk082] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk082_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk082 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk082_subset_fullBlockExplicit hp
