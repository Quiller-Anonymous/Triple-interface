...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk153, JSON indices [15300,15400). -/

def PeriodicMainNonzeroRecordPairsChunk153 : Finset (ℕ × ℕ) :=
  ([
    (259, 74),
    (259, 77),
    (259, 91),
...
theorem PeriodicMainNonzeroRecordPairsChunk153_card :
    PeriodicMainNonzeroRecordPairsChunk153.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk153_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk153 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk153] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk153_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk153 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk153_subset_fullBlockExplicit hp
