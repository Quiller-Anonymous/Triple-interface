...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk000, JSON indices [0,100). -/

def PeriodicMainZeroDyadicExceptionPairsChunk000 : Finset (ℕ × ℕ) :=
  ([
    (3, 1),
    (3, 2),
    (3, 5),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk000_card :
    PeriodicMainZeroDyadicExceptionPairsChunk000.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk000_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk000] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk000_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk000 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk000_subset_fullBlockExplicit hp
