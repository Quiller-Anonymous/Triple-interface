...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk051, JSON indices [5100,5200). -/

def PeriodicMainZeroDyadicExceptionPairsChunk051 : Finset (ℕ × ℕ) :=
  ([
    (334, 6),
    (335, 3),
    (335, 6),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk051_card :
    PeriodicMainZeroDyadicExceptionPairsChunk051.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk051_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk051] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk051_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk051_subset_fullBlockExplicit hp
