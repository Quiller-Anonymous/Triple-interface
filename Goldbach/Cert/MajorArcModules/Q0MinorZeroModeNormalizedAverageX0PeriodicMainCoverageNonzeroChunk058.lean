...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk058, JSON indices [5800,5900). -/

def PeriodicMainNonzeroRecordPairsChunk058 : Finset (ℕ × ℕ) :=
  ([
    (29, 3422),
    (29, 3451),
    (29, 3538),
...
theorem PeriodicMainNonzeroRecordPairsChunk058_card :
    PeriodicMainNonzeroRecordPairsChunk058.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk058_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk058 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk058] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk058_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk058 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk058_subset_fullBlockExplicit hp
