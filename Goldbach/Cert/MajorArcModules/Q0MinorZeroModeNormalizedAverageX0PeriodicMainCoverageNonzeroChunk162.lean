...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk162, JSON indices [16200,16300). -/

def PeriodicMainNonzeroRecordPairsChunk162 : Finset (ℕ × ℕ) :=
  ([
    (318, 7),
    (318, 10),
    (318, 11),
...
theorem PeriodicMainNonzeroRecordPairsChunk162_card :
    PeriodicMainNonzeroRecordPairsChunk162.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk162_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk162 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk162] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk162_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk162 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk162_subset_fullBlockExplicit hp
