...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk203, JSON indices [20300,20400). -/

def PeriodicMainNonzeroRecordPairsChunk203 : Finset (ℕ × ℕ) :=
  ([
    (777, 35),
    (777, 37),
    (777, 74),
...
theorem PeriodicMainNonzeroRecordPairsChunk203_card :
    PeriodicMainNonzeroRecordPairsChunk203.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk203_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk203 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk203] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk203_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk203 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk203_subset_fullBlockExplicit hp
