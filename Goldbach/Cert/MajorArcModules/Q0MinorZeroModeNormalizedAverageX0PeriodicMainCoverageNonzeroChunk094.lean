...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk094, JSON indices [9400,9500). -/

def PeriodicMainNonzeroRecordPairsChunk094 : Finset (ℕ × ℕ) :=
  ([
    (69, 4071),
    (69, 4209),
    (69, 4278),
...
theorem PeriodicMainNonzeroRecordPairsChunk094_card :
    PeriodicMainNonzeroRecordPairsChunk094.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk094_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk094 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk094] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk094_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk094 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk094_subset_fullBlockExplicit hp
