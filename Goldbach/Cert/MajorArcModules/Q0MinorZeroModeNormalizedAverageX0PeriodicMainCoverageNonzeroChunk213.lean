...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk213, JSON indices [21300,21400). -/

def PeriodicMainNonzeroRecordPairsChunk213 : Finset (ℕ × ℕ) :=
  ([
    (957, 66),
    (957, 87),
    (957, 145),
...
theorem PeriodicMainNonzeroRecordPairsChunk213_card :
    PeriodicMainNonzeroRecordPairsChunk213.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk213_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk213 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk213] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk213_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk213 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk213_subset_fullBlockExplicit hp
