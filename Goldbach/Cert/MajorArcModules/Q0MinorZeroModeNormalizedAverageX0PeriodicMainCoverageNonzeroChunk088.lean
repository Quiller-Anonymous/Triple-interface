...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk088, JSON indices [8800,8900). -/

def PeriodicMainNonzeroRecordPairsChunk088 : Finset (ℕ × ℕ) :=
  ([
    (61, 4453),
    (61, 4514),
    (61, 4697),
...
theorem PeriodicMainNonzeroRecordPairsChunk088_card :
    PeriodicMainNonzeroRecordPairsChunk088.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk088_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk088 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk088] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 62 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 62 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk088_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk088 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk088_subset_fullBlockExplicit hp
