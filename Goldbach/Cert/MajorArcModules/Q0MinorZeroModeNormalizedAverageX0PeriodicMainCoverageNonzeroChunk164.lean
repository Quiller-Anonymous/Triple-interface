...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk164, JSON indices [16400,16500). -/

def PeriodicMainNonzeroRecordPairsChunk164 : Finset (ℕ × ℕ) :=
  ([
    (327, 30),
    (327, 33),
    (327, 39),
...
theorem PeriodicMainNonzeroRecordPairsChunk164_card :
    PeriodicMainNonzeroRecordPairsChunk164.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk164_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk164 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk164] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk164_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk164 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk164_subset_fullBlockExplicit hp
