...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk038, JSON indices [3800,3900). -/

def PeriodicMainZeroRecordPairsChunk038 : Finset (ℕ × ℕ) :=
  ([
    (2, 1249),
    (2, 1253),
    (2, 1254),
...
theorem PeriodicMainZeroRecordPairsChunk038_card :
    PeriodicMainZeroRecordPairsChunk038.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk038_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk038 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk038] at hp
...
theorem PeriodicMainZeroRecordPairsChunk038_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk038 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk038_subset_fullBlockExplicit hp
