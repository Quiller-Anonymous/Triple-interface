...
/- Generated periodic-main ordered-record proofs for JSON indices [0,1). -/
...
def PeriodicMainRecordsZeroResidualOne000Pairs : Finset (ℕ × ℕ) :=
  [(7, 2667)].toFinset

theorem PeriodicMainRecordsZeroResidualOne000_value_on_records :
    ∀ p ∈ PeriodicMainRecordsZeroResidualOne000Pairs,
      surrogatePeriodicMainActiveOrderedPairSummandRat X0 p = 0 := by
  intro p hp
  simp [PeriodicMainRecordsZeroResidualOne000Pairs] at hp
  rcases hp with h
  · subst p
