...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk091, JSON indices [9100,9200). -/

def PeriodicMainZeroRecordPairsChunk091 : Finset (ℕ × ℕ) :=
  ([
    (85, 102),
    (85, 357),
    (85, 714),
...
theorem PeriodicMainZeroRecordPairsChunk091_card :
    PeriodicMainZeroRecordPairsChunk091.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk091_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk091 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk091] at hp
...
theorem PeriodicMainZeroRecordPairsChunk091_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk091 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk091_subset_fullBlockExplicit hp
