...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk087, JSON indices [8700,8800). -/

def PeriodicMainZeroRecordPairsChunk087 : Finset (ℕ × ℕ) :=
  ([
    (42, 3570),
    (42, 3738),
    (42, 3990),
...
theorem PeriodicMainZeroRecordPairsChunk087_card :
    PeriodicMainZeroRecordPairsChunk087.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk087_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk087 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk087] at hp
...
theorem PeriodicMainZeroRecordPairsChunk087_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk087 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk087_subset_fullBlockExplicit hp
