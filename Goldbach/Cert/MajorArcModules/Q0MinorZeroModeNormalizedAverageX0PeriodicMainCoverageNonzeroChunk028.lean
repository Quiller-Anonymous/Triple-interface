...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk028, JSON indices [2800,2900). -/

def PeriodicMainNonzeroRecordPairsChunk028 : Finset (ℕ × ℕ) :=
  ([
    (11, 4411),
    (11, 4422),
    (11, 4433),
...
theorem PeriodicMainNonzeroRecordPairsChunk028_card :
    PeriodicMainNonzeroRecordPairsChunk028.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk028_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk028 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk028] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk028_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk028 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk028_subset_fullBlockExplicit hp
