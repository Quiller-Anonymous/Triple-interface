...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk024, JSON indices [2400,2500). -/

def PeriodicMainNonzeroRecordPairsChunk024 : Finset (ℕ × ℕ) :=
  ([
    (11, 101),
    (11, 103),
    (11, 105),
...
theorem PeriodicMainNonzeroRecordPairsChunk024_card :
    PeriodicMainNonzeroRecordPairsChunk024.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk024_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk024 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk024] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk024_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk024 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk024_subset_fullBlockExplicit hp
