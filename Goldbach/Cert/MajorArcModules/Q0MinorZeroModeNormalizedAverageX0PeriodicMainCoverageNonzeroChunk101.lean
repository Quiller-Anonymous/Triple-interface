...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk101, JSON indices [10100,10200). -/

def PeriodicMainNonzeroRecordPairsChunk101 : Finset (ℕ × ℕ) :=
  ([
    (79, 53),
    (79, 55),
    (79, 57),
...
theorem PeriodicMainNonzeroRecordPairsChunk101_card :
    PeriodicMainNonzeroRecordPairsChunk101.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk101_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk101 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk101] at hp
  ...
  · subst p
    have hqCoeff : 79 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 53 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 79 ∈ PeriodicMainActiveSupportExplicit := by
...
theorem PeriodicMainNonzeroRecordPairsChunk101_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk101 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk101_subset_fullBlockExplicit hp
