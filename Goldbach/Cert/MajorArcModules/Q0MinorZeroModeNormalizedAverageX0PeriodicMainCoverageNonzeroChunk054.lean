...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk054, JSON indices [5400,5500). -/

def PeriodicMainNonzeroRecordPairsChunk054 : Finset (ℕ × ℕ) :=
  ([
    (26, 69),
    (26, 70),
    (26, 71),
...
theorem PeriodicMainNonzeroRecordPairsChunk054_card :
    PeriodicMainNonzeroRecordPairsChunk054.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk054_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk054 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk054] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk054_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk054 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk054_subset_fullBlockExplicit hp
