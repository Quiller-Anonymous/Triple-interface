...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk016, JSON indices [1600,1700). -/

def PeriodicMainZeroDyadicExceptionPairsChunk016 : Finset (ℕ × ℕ) :=
  ([
    (6, 67),
    (6, 69),
    (6, 70),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk016_card :
    PeriodicMainZeroDyadicExceptionPairsChunk016.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk016_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk016 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk016] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk016_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk016 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk016_subset_fullBlockExplicit hp
