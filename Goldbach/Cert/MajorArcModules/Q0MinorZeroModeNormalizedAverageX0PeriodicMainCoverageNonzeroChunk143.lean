...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk143, JSON indices [14300,14400). -/

def PeriodicMainNonzeroRecordPairsChunk143 : Finset (ℕ × ℕ) :=
  ([
    (209, 2926),
    (209, 3135),
    (209, 3553),
...
theorem PeriodicMainNonzeroRecordPairsChunk143_card :
    PeriodicMainNonzeroRecordPairsChunk143.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk143_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk143 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk143] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk143_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk143 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk143_subset_fullBlockExplicit hp
