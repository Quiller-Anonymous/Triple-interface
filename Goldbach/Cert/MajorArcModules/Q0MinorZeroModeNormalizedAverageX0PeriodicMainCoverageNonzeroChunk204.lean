...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk204, JSON indices [20400,20500). -/

def PeriodicMainNonzeroRecordPairsChunk204 : Finset (ℕ × ℕ) :=
  ([
    (790, 30),
    (790, 79),
    (790, 158),
...
theorem PeriodicMainNonzeroRecordPairsChunk204_card :
    PeriodicMainNonzeroRecordPairsChunk204.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk204_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk204 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk204] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk204_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk204 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk204_subset_fullBlockExplicit hp
