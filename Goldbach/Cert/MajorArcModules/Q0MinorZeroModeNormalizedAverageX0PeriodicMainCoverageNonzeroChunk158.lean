...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk158, JSON indices [15800,15900). -/

def PeriodicMainNonzeroRecordPairsChunk158 : Finset (ℕ × ℕ) :=
  ([
    (290, 11),
    (290, 13),
    (290, 14),
...
theorem PeriodicMainNonzeroRecordPairsChunk158_card :
    PeriodicMainNonzeroRecordPairsChunk158.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk158_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk158 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk158] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk158_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk158 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk158_subset_fullBlockExplicit hp
