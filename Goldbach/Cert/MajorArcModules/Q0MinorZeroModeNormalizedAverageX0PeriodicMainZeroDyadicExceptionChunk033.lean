...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk033, JSON indices [3300,3400). -/

def PeriodicMainZeroDyadicExceptionPairsChunk033 : Finset (ℕ × ℕ) :=
  ([
    (38, 129),
    (38, 222),
    (38, 258),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk033_card :
    PeriodicMainZeroDyadicExceptionPairsChunk033.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk033_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk033 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk033] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk033_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk033 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk033_subset_fullBlockExplicit hp
