...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk123, JSON indices [12300,12400). -/

def PeriodicMainNonzeroRecordPairsChunk123 : Finset (ℕ × ℕ) :=
  ([
    (134, 1742),
    (134, 1943),
    (134, 2010),
...
theorem PeriodicMainNonzeroRecordPairsChunk123_card :
    PeriodicMainNonzeroRecordPairsChunk123.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk123_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk123 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk123] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk123_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk123 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk123_subset_fullBlockExplicit hp
