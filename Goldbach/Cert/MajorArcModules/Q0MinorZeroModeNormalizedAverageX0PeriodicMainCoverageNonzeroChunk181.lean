...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk181, JSON indices [18100,18200). -/

def PeriodicMainNonzeroRecordPairsChunk181 : Finset (ℕ × ℕ) :=
  ([
    (478, 1673),
    (478, 2390),
    (478, 3346),
...
theorem PeriodicMainNonzeroRecordPairsChunk181_card :
    PeriodicMainNonzeroRecordPairsChunk181.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk181_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk181 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk181] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk181_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk181 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk181_subset_fullBlockExplicit hp
