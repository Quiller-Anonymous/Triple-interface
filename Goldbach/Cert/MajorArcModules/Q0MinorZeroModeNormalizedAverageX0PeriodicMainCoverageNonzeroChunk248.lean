...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk248, JSON indices [24800,24900). -/

def PeriodicMainNonzeroRecordPairsChunk248 : Finset (ℕ × ℕ) :=
  ([
    (1985, 3970),
    (1986, 993),
    (1987, 3974),
...
theorem PeriodicMainNonzeroRecordPairsChunk248_card :
    PeriodicMainNonzeroRecordPairsChunk248.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk248_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk248 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk248] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk248_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk248 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk248_subset_fullBlockExplicit hp
