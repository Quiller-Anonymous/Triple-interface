...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk029, JSON indices [2900,3000). -/

def PeriodicMainNonzeroRecordPairsChunk029 : Finset (ℕ × ℕ) :=
  ([
    (13, 131),
    (13, 133),
    (13, 134),
...
theorem PeriodicMainNonzeroRecordPairsChunk029_card :
    PeriodicMainNonzeroRecordPairsChunk029.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk029_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk029 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk029] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk029_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk029 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk029_subset_fullBlockExplicit hp
