...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk059, JSON indices [5900,6000). -/

def PeriodicMainZeroRecordPairsChunk059 : Finset (ℕ × ℕ) :=
  ([
    (3, 1365),
    (3, 1366),
    (3, 1367),
...
theorem PeriodicMainZeroRecordPairsChunk059_card :
    PeriodicMainZeroRecordPairsChunk059.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk059_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk059 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk059] at hp
...
theorem PeriodicMainZeroRecordPairsChunk059_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk059 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk059_subset_fullBlockExplicit hp
