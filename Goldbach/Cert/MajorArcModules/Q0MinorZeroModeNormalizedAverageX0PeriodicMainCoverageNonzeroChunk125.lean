...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk125, JSON indices [12500,12600). -/

def PeriodicMainNonzeroRecordPairsChunk125 : Finset (ℕ × ℕ) :=
  ([
    (141, 799),
    (141, 893),
    (141, 987),
...
theorem PeriodicMainNonzeroRecordPairsChunk125_card :
    PeriodicMainNonzeroRecordPairsChunk125.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk125_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk125 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk125] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk125_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk125 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk125_subset_fullBlockExplicit hp
