...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk112, JSON indices [11200,11300). -/

def PeriodicMainNonzeroRecordPairsChunk112 : Finset (ℕ × ℕ) :=
  ([
    (105, 555),
    (105, 570),
    (105, 595),
...
theorem PeriodicMainNonzeroRecordPairsChunk112_card :
    PeriodicMainNonzeroRecordPairsChunk112.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk112_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk112 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk112] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk112_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk112 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk112_subset_fullBlockExplicit hp
