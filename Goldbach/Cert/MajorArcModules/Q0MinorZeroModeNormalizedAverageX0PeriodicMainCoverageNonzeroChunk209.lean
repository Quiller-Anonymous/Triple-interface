...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk209, JSON indices [20900,21000). -/

def PeriodicMainNonzeroRecordPairsChunk209 : Finset (ℕ × ℕ) :=
  ([
    (890, 10),
    (890, 15),
    (890, 30),
...
theorem PeriodicMainNonzeroRecordPairsChunk209_card :
    PeriodicMainNonzeroRecordPairsChunk209.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk209_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk209 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk209] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk209_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk209 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk209_subset_fullBlockExplicit hp
