...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk302, JSON indices [30200,30300). -/

def PeriodicMainNonzeroRecordPairsChunk302 : Finset (ℕ × ℕ) :=
  ([
    (4757, 67),
    (4757, 71),
    (4758, 13),
...
theorem PeriodicMainNonzeroRecordPairsChunk302_card :
    PeriodicMainNonzeroRecordPairsChunk302.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk302_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk302 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk302] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk302_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk302 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk302_subset_fullBlockExplicit hp
