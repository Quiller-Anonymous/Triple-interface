...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk186, JSON indices [18600,18700). -/

def PeriodicMainNonzeroRecordPairsChunk186 : Finset (ℕ × ℕ) :=
  ([
    (543, 905),
    (543, 1086),
    (543, 1267),
...
theorem PeriodicMainNonzeroRecordPairsChunk186_card :
    PeriodicMainNonzeroRecordPairsChunk186.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk186_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk186 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk186] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk186_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk186 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk186_subset_fullBlockExplicit hp
