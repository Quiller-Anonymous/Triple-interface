...
def Q69SurrogateDiagonalTermCertificateAtX0 : Prop :=
...
theorem surrogateDiagonalTailChunk000Sub000Part021_eq_cert_explicit :
    Q69SurrogateDiagonalTermCertificateAtX0 →
    (∑ q ∈ tailChunk000Sub000Part021SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part021 := by
  intro hcert
  unfold Q69SurrogateDiagonalTermCertificateAtX0 at hcert
  simpa [tailChunk000Sub000Part021SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part021] using hcert
...
def Q77SurrogateDiagonalTermCertificateAtX0 : Prop :=
...
theorem surrogateDiagonalTailChunk000Sub000Part022_eq_cert_explicit :
    Q77SurrogateDiagonalTermCertificateAtX0 →
    (∑ q ∈ tailChunk000Sub000Part022SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part022 := by
  intro hcert
  unfold Q77SurrogateDiagonalTermCertificateAtX0 at hcert
  simpa [tailChunk000Sub000Part022SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part022] using hcert
...
def Q85SurrogateDiagonalTermCertificateAtX0 : Prop :=
...
theorem surrogateDiagonalTailChunk000Sub000Part023_eq_cert_explicit :
    Q85SurrogateDiagonalTermCertificateAtX0 →
    (∑ q ∈ tailChunk000Sub000Part023SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part023 := by
  intro hcert
  unfold Q85SurrogateDiagonalTermCertificateAtX0 at hcert
  simpa [tailChunk000Sub000Part023SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part023] using hcert
...
def Q87SurrogateDiagonalTermCertificateAtX0 : Prop :=
...
theorem surrogateDiagonalTailChunk000Sub000Part024_eq_cert_explicit :
    Q87SurrogateDiagonalTermCertificateAtX0 →
    (∑ q ∈ tailChunk000Sub000Part024SupportExplicit,
        surrogateCenteredNormalizedSigmaTruncSummandWindowEnergyRat X0 q)
      = surrogateDiagTailX0RatChunk000Sub000Part024 := by
  intro hcert
  unfold Q87SurrogateDiagonalTermCertificateAtX0 at hcert
  simpa [tailChunk000Sub000Part024SupportExplicit,
    surrogateDiagTailX0RatChunk000Sub000Part024] using hcert
