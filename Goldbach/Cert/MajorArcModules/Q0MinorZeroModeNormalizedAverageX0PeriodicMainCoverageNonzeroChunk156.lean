...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk156, JSON indices [15600,15700). -/

def PeriodicMainNonzeroRecordPairsChunk156 : Finset (ℕ × ℕ) :=
  ([
    (281, 5),
    (281, 7),
    (281, 10),
...
theorem PeriodicMainNonzeroRecordPairsChunk156_card :
    PeriodicMainNonzeroRecordPairsChunk156.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk156_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk156 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk156] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk156_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk156 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk156_subset_fullBlockExplicit hp
