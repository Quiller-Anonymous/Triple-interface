...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk051, JSON indices [5100,5200). -/

def PeriodicMainNonzeroRecordPairsChunk051 : Finset (ℕ × ℕ) :=
  ([
    (22, 3806),
    (22, 3894),
    (22, 3938),
...
theorem PeriodicMainNonzeroRecordPairsChunk051_card :
    PeriodicMainNonzeroRecordPairsChunk051.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk051_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk051] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk051_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk051 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk051_subset_fullBlockExplicit hp
