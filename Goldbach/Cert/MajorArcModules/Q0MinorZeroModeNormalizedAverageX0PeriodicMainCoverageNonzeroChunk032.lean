...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk032, JSON indices [3200,3300). -/

def PeriodicMainNonzeroRecordPairsChunk032 : Finset (ℕ × ℕ) :=
  ([
    (13, 4030),
    (13, 4043),
    (13, 4069),
...
theorem PeriodicMainNonzeroRecordPairsChunk032_card :
    PeriodicMainNonzeroRecordPairsChunk032.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk032_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk032 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk032] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk032_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk032 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk032_subset_fullBlockExplicit hp
