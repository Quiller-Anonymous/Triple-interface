...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk114, JSON indices [11400,11500). -/

def PeriodicMainNonzeroRecordPairsChunk114 : Finset (ℕ × ℕ) :=
  ([
    (109, 1417),
    (109, 1526),
    (109, 1635),
...
theorem PeriodicMainNonzeroRecordPairsChunk114_card :
    PeriodicMainNonzeroRecordPairsChunk114.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk114_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk114 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk114] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk114_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk114 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk114_subset_fullBlockExplicit hp
