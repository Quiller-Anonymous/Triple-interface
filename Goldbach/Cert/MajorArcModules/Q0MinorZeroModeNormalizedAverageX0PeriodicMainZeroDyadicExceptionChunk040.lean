...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk040, JSON indices [4000,4100). -/

def PeriodicMainZeroDyadicExceptionPairsChunk040 : Finset (ℕ × ℕ) :=
  ([
    (102, 15),
    (102, 17),
    (102, 19),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk040_card :
    PeriodicMainZeroDyadicExceptionPairsChunk040.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk040_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk040 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk040] at hp
  ...
  · subst p
    have hqCoeff : 102 ∈ PeriodicMainCoeffSupportExplicit := by
    ...
    have hq2Coeff : 15 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 102 ∈ PeriodicMainActiveSupportExplicit := by
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk040_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk040 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk040_subset_fullBlockExplicit hp
