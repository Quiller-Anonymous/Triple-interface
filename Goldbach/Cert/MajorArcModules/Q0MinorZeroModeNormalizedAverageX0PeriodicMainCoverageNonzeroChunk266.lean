...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk266, JSON indices [26600,26700). -/

def PeriodicMainNonzeroRecordPairsChunk266 : Finset (ℕ × ℕ) :=
  ([
    (2702, 386),
    (2702, 1351),
    (2703, 17),
...
theorem PeriodicMainNonzeroRecordPairsChunk266_card :
    PeriodicMainNonzeroRecordPairsChunk266.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk266_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk266 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk266] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk266_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk266 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk266_subset_fullBlockExplicit hp
