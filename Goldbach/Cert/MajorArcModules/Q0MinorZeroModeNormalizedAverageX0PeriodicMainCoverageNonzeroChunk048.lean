...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk048, JSON indices [4800,4900). -/

def PeriodicMainNonzeroRecordPairsChunk048 : Finset (ℕ × ℕ) :=
  ([
    (22, 11),
    (22, 13),
    (22, 14),
...
theorem PeriodicMainNonzeroRecordPairsChunk048_card :
    PeriodicMainNonzeroRecordPairsChunk048.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk048_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk048 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk048] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk048_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk048 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk048_subset_fullBlockExplicit hp
