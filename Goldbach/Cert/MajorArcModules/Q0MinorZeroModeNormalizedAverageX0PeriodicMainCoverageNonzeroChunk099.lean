...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk099, JSON indices [9900,10000). -/

def PeriodicMainNonzeroRecordPairsChunk099 : Finset (ℕ × ℕ) :=
  ([
    (77, 406),
    (77, 407),
    (77, 413),
...
theorem PeriodicMainNonzeroRecordPairsChunk099_card :
    PeriodicMainNonzeroRecordPairsChunk099.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk099_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk099 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk099] at hp
  ...
  · subst p
    ...
    ⟩
  · subst p
    have hqCoeff : 78 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hq2Coeff : 5 ∈ PeriodicMainCoeffSupportExplicit := by
      unfold PeriodicMainCoeffSupportExplicit
      exact mem_normalizedSigmaTruncSummandCoeffSupportUpToQ0_iff.mpr ⟨by norm_num, by native_decide⟩
    have hqActive : 78 ∈ PeriodicMainActiveSupportExplicit := by
      unfold PeriodicMainActiveSupportExplicit
      exact Finset.mem_filter.mpr ⟨hqCoeff, by norm_num [H]⟩
...
theorem PeriodicMainNonzeroRecordPairsChunk099_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk099 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk099_subset_fullBlockExplicit hp
