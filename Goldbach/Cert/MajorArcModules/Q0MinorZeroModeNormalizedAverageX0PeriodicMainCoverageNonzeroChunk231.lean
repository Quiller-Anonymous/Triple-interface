...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk231, JSON indices [23100,23200). -/

def PeriodicMainNonzeroRecordPairsChunk231 : Finset (ℕ × ℕ) :=
  ([
    (1411, 166),
    (1411, 2822),
    (1414, 7),
...
theorem PeriodicMainNonzeroRecordPairsChunk231_card :
    PeriodicMainNonzeroRecordPairsChunk231.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk231_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk231 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk231] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk231_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk231 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk231_subset_fullBlockExplicit hp
