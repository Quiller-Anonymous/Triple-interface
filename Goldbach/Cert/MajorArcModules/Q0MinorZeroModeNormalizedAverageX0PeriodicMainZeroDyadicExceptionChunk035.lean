...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroDyadicExceptionPairsChunk035, JSON indices [3500,3600). -/

def PeriodicMainZeroDyadicExceptionPairsChunk035 : Finset (ℕ × ℕ) :=
  ([
    (42, 609),
    (42, 618),
    (42, 623),
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk035_card :
    PeriodicMainZeroDyadicExceptionPairsChunk035.card = 100 := by
  native_decide

theorem PeriodicMainZeroDyadicExceptionPairsChunk035_subset_fullBlockExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk035 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroDyadicExceptionPairsChunk035] at hp
...
theorem PeriodicMainZeroDyadicExceptionPairsChunk035_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroDyadicExceptionPairsChunk035 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroDyadicExceptionPairsChunk035_subset_fullBlockExplicit hp
