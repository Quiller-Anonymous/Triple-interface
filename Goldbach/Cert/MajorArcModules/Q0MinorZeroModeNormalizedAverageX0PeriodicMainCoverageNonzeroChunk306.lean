...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk306, JSON indices [30600,30658). -/

def PeriodicMainNonzeroRecordPairsChunk306 : Finset (ℕ × ℕ) :=
  ([
    (4965, 1655),
    (4966, 13),
    (4966, 26),
...
theorem PeriodicMainNonzeroRecordPairsChunk306_card :
    PeriodicMainNonzeroRecordPairsChunk306.card = 58 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk306_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk306 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk306] at hp
  rcases hp with h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h | h
  · subst p
...
theorem PeriodicMainNonzeroRecordPairsChunk306_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk306 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk306_subset_fullBlockExplicit hp
