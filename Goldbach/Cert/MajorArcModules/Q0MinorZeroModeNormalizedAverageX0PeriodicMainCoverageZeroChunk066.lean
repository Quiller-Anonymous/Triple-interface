...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainZeroRecordPairsChunk066, JSON indices [6600,6700). -/

def PeriodicMainZeroRecordPairsChunk066 : Finset (ℕ × ℕ) :=
  ([
    (5, 51),
    (5, 102),
    (5, 111),
...
theorem PeriodicMainZeroRecordPairsChunk066_card :
    PeriodicMainZeroRecordPairsChunk066.card = 100 := by
  native_decide

theorem PeriodicMainZeroRecordPairsChunk066_subset_fullBlockExplicit :
    PeriodicMainZeroRecordPairsChunk066 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainZeroRecordPairsChunk066] at hp
...
theorem PeriodicMainZeroRecordPairsChunk066_subset_fullBlockSquarefreeExplicit :
    PeriodicMainZeroRecordPairsChunk066 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainZeroRecordPairsChunk066_subset_fullBlockExplicit hp
