...
/- Generated periodic-main ordered-record coverage facts for PeriodicMainNonzeroRecordPairsChunk200, JSON indices [20000,20100). -/

def PeriodicMainNonzeroRecordPairsChunk200 : Finset (ℕ × ℕ) :=
  ([
    (718, 2154),
    (718, 3590),
    (719, 5),
...
theorem PeriodicMainNonzeroRecordPairsChunk200_card :
    PeriodicMainNonzeroRecordPairsChunk200.card = 100 := by
  native_decide

theorem PeriodicMainNonzeroRecordPairsChunk200_subset_fullBlockExplicit :
    PeriodicMainNonzeroRecordPairsChunk200 ⊆ PeriodicMainFullBlockOrderedPairSupportExplicit := by
  intro p hp
  simp [PeriodicMainNonzeroRecordPairsChunk200] at hp
...
theorem PeriodicMainNonzeroRecordPairsChunk200_subset_fullBlockSquarefreeExplicit :
    PeriodicMainNonzeroRecordPairsChunk200 ⊆ PeriodicMainFullBlockOrderedPairSupportSquarefreeExplicit := by
  intro p hp
  rw [← PeriodicMainFullBlockOrderedPairSupportExplicit_eq_squarefreeExplicit]
  exact PeriodicMainNonzeroRecordPairsChunk200_subset_fullBlockExplicit hp
