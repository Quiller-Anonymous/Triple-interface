...
/-- Final finite-conditional theorem for the variable-scale, variable-slack witness route. -/
theorem goldbach_final_scaleNormEps
    (w : PointwiseWitnessScaleNormEps) (hBase : FiniteBaseUpTo w.X0) :
  ...
  ·
    ...
    exact PointwiseWitnessScaleNormEps.representable_large (w := w) hEven' hX
