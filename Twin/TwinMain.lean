...
/-- Shorthands for the concrete parameters and bricks. -/
def P  : GoalAPI.Params := Twin.PaperParams.P
def b  : Twin.PaperBricks.Bricks P := Twin.PaperBricks_Instance.bricks
def P' : GoalAPI.Params := Twin.TwinFinalize.P' P b
